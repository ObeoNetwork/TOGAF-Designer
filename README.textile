 ...
 * http://docs.obeonetwork.com/togaf
 * http://www.obeodesigner.com


To build the module you'll need Maven3 (with Tycho plugin) and run @mvn clean verify@ in @releng/org.obeonetwork.dsl.togaf.aggregator@ directory.
