...
public class ElementImpl extends CDOObjectImpl implements Element {
	...
	public EList<Element> getDelegates() {
		return (EList<Element>) eDynamicGet(ContentfwkPackage.ELEMENT__DELEGATES,
	...
	public EList<Element> getIsDelegatedBy() {
		return (EList<Element>) eDynamicGet(ContentfwkPackage.ELEMENT__IS_DELEGATED_BY,
	...
	public String getName() {
		return (String) eDynamicGet(ContentfwkPackage.ELEMENT__NAME, ContentfwkPackage.Literals.ELEMENT__NAME, true,
				true);
	}
	...
	public void setDescription(String newDescription) {
		eDynamicSet(ContentfwkPackage.ELEMENT__DESCRIPTION, ContentfwkPackage.Literals.ELEMENT__DESCRIPTION,
				newDescription);
	}
	...
	public String getCategory() {
		return (String) eDynamicGet(ContentfwkPackage.ELEMENT__CATEGORY, ContentfwkPackage.Literals.ELEMENT__CATEGORY,
				true, true);
	}
	 ...
	 * 
	 * @see org.obeonetwork.dsl.togaf.contentfwk.contentfwk.util.
	 *      ContentfwkPreferences <!-- end-user-doc -->
	 * @generated NOT
	 */
	...
	public void setSourceDescr(String newSourceDescr) {
		eDynamicSet(ContentfwkPackage.ELEMENT__SOURCE_DESCR, ContentfwkPackage.Literals.ELEMENT__SOURCE_DESCR,
				newSourceDescr);
	}
	...
	public void setOwnerDescr(String newOwnerDescr) {
		eDynamicSet(ContentfwkPackage.ELEMENT__OWNER_DESCR, ContentfwkPackage.Literals.ELEMENT__OWNER_DESCR,
				newOwnerDescr);
	}
