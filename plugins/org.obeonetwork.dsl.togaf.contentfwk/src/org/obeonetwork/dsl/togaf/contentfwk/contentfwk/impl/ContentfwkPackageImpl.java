...
public class ContentfwkPackageImpl extends EPackageImpl implements ContentfwkPackage {
	 ...
	 * @generated
	 */
	public EReference getEnterpriseArchitecture_Containers() {
		return (EReference)enterpriseArchitectureEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getActor_SuppliesEntities() {
	 ...
	 * @generated
	 */
	public EReference getActor_ConsumesEntities() {
	 ...
	 * @generated
	 */
	public EReference getActor_BelongsTo() {
	 ...
	 * @generated
	 */
	public EReference getActor_DecomposesActors() {
	 ...
	 * @generated
	 */
	public EReference getDataEntity_DecomposeEntity() {
	 ...
	 * @generated
	 */
	public EReference getFunction_IsOwnedByUnit() {
	 ...
	 * @generated
	 */
	public EReference getFunction_CommunicatedWithFunctions() {
	 ...
	 * @generated
	 */
	public EReference getPhysicalTechnologyComponent_RealizesApplicationComponents() {
	 ...
	 * @generated
	 */
	public EReference getEvent_IsResolvedByBusinessServices() {
	 ...
	 * @generated
	 */
	public EReference getContainer_OwnsElements() {
	 ...
	 * @generated
	 */
	public EAttribute getPhysicalApplicationComponent_AvailabilityQualityCharacteristics() {
	 ...
	 * @generated
	 */
	public EAttribute getStandard_LastStandardCreationDate() {
	 ...
	 * @generated
	 */
	public EAttribute getStandard_NextStandardCreationDate() {
	 ...
	 * @generated
	 */
	public EReference getService_ProvidesEntities() {
	 ...
	 * @generated
	 */
	public EReference getService_ConsumesEntities() {
	 ...
	 * @generated
	 */
	public EReference getService_MeetsQualities() {
	...
	public void createPackageContents() {
		...
		createEReference(actorEClass, ACTOR__SUPPLIES_ENTITIES);
		createEReference(actorEClass, ACTOR__CONSUMES_ENTITIES);
		createEReference(actorEClass, ACTOR__BELONGS_TO);
		...
		createEReference(actorEClass, ACTOR__DECOMPOSES_ACTORS);
		...
		createEReference(functionEClass, FUNCTION__IS_OWNED_BY_UNIT);
		...
		createEReference(functionEClass, FUNCTION__COMMUNICATED_WITH_FUNCTIONS);
		...
		createEReference(eventEClass, EVENT__IS_RESOLVED_BY_BUSINESS_SERVICES);
		...
		createEAttribute(physicalApplicationComponentEClass, PHYSICAL_APPLICATION_COMPONENT__AVAILABILITY_QUALITY_CHARACTERISTICS);
		...
		createEAttribute(standardEClass, STANDARD__LAST_STANDARD_CREATION_DATE);
		createEAttribute(standardEClass, STANDARD__NEXT_STANDARD_CREATION_DATE);
		...
		createEReference(serviceEClass, SERVICE__PROVIDES_ENTITIES);
		createEReference(serviceEClass, SERVICE__CONSUMES_ENTITIES);
		...
		createEReference(serviceEClass, SERVICE__MEETS_QUALITIES);
	...
	public void initializePackageContents() {
		...
		initEReference(getDriver_DecomposesDriver(), this.getDriver(), null, "decomposesDriver", null, 0, 1, Driver.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getGoal_DecomposesGoal(), this.getGoal(), null, "decomposesGoal", null, 0, 1, Goal.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getObjective_DecomposesObjective(), this.getObjective(), null, "decomposesObjective", null, 0, 1, Objective.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getOrganizationUnit_ContainsActors(), this.getActor(), this.getActor_BelongsTo(), "containsActors", null, 0, -1, OrganizationUnit.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getOrganizationUnit_OwnsFunctions(), this.getFunction(), this.getFunction_IsOwnedByUnit(), "ownsFunctions", null, 0, -1, OrganizationUnit.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getActor_SuppliesEntities(), this.getDataEntity(), this.getDataEntity_IsSuppliedByActors(), "suppliesEntities", null, 0, -1, Actor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getActor_ConsumesEntities(), this.getDataEntity(), this.getDataEntity_IsConsumedByActors(), "consumesEntities", null, 0, -1, Actor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getActor_BelongsTo(), this.getOrganizationUnit(), this.getOrganizationUnit_ContainsActors(), "belongsTo", null, 0, 1, Actor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getActor_ConsumesServices(), this.getService(), null, "consumesServices", null, 0, -1, Actor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getRole_DecomposesRole(), this.getRole(), null, "decomposesRole", null, 0, 1, Role.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(dataEntityEClass, DataEntity.class, "DataEntity", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getDataEntity_IsSuppliedByActors(), this.getActor(), this.getActor_SuppliesEntities(), "isSuppliedByActors", null, 0, -1, DataEntity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDataEntity_IsConsumedByActors(), this.getActor(), this.getActor_ConsumesEntities(), "isConsumedByActors", null, 0, -1, DataEntity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDataEntity_IsAccessedByServices(), this.getService(), this.getService_ConsumesEntities(), "isAccessedByServices", null, 0, -1, DataEntity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDataEntity_IsUpdatedThroughServices(), this.getService(), this.getService_ProvidesEntities(), "isUpdatedThroughServices", null, 0, -1, DataEntity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getFunction_IsOwnedByUnit(), this.getOrganizationUnit(), this.getOrganizationUnit_OwnsFunctions(), "isOwnedByUnit", null, 0, 1, Function.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getFunction_DecomposesFunction(), this.getFunction(), null, "decomposesFunction", null, 0, 1, Function.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFunction_CommunicatedWithFunctions(), this.getFunction(), null, "communicatedWithFunctions", null, 0, -1, Function.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getBusinessService_SupportsObjective(), this.getObjective(), null, "supportsObjective", null, 0, -1, BusinessService.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getMeasure_DecomposesMeasure(), this.getMeasure(), null, "decomposesMeasure", null, 0, 1, Measure.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(serviceQualityEClass, ServiceQuality.class, "ServiceQuality", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getServiceQuality_AppliesToServices(), this.getService(), this.getService_MeetsQualities(), "appliesToServices", null, 0, -1, ServiceQuality.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getEvent_IsResolvedByBusinessServices(), this.getService(), this.getService_ResolvesEvents(), "isResolvedByBusinessServices", null, 0, -1, Event.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getLocation_DecomposesLocation(), this.getLocation(), null, "decomposesLocation", null, 0, 1, Location.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getPhysicalDataComponent_DecomposesPhysicalDataComponent(), this.getPhysicalDataComponent(), null, "decomposesPhysicalDataComponent", null, 0, 1, PhysicalDataComponent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPhysicalDataComponent_EncapsulatesPhysicalApplicationComponents(), this.getPhysicalApplicationComponent(), null, "encapsulatesPhysicalApplicationComponents", null, 0, -1, PhysicalDataComponent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getPhysicalApplicationComponent_AvailabilityQualityCharacteristics(), ecorePackage.getEString(), "availabilityQualityCharacteristics", null, 0, 1, PhysicalApplicationComponent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getStandard_LastStandardCreationDate(), ecorePackage.getEDate(), "lastStandardCreationDate", null, 0, 1, Standard.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getStandard_NextStandardCreationDate(), ecorePackage.getEDate(), "nextStandardCreationDate", null, 0, 1, Standard.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getService_IsProvidedToActors(), this.getActor(), null, "isProvidedToActors", null, 0, -1, Service.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getService_ProvidesEntities(), this.getDataEntity(), this.getDataEntity_IsUpdatedThroughServices(), "providesEntities", null, 0, -1, Service.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getService_ConsumesEntities(), this.getDataEntity(), this.getDataEntity_IsAccessedByServices(), "consumesEntities", null, 0, -1, Service.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getService_ResolvesEvents(), this.getEvent(), this.getEvent_IsResolvedByBusinessServices(), "resolvesEvents", null, 0, -1, Service.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getService_MeetsQualities(), this.getServiceQuality(), this.getServiceQuality_AppliesToServices(), "meetsQualities", null, 0, -1, Service.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getService_DecomposesServices(), this.getService(), null, "decomposesServices", null, 0, -1, Service.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
