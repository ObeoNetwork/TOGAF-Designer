...
public class ActorImpl extends ElementImpl implements Actor {
	...
	public Actor getDecomposesActors() {
		return (Actor)eGet(ContentfwkPackage.Literals.ACTOR__DECOMPOSES_ACTORS, true);
	}
	...
	public void setDecomposesActors(Actor newDecomposesActors) {
		eSet(ContentfwkPackage.Literals.ACTOR__DECOMPOSES_ACTORS, newDecomposesActors);
	}
