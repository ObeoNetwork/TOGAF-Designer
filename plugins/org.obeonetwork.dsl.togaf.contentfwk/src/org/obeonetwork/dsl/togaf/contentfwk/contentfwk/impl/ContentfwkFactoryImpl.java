...
public class ContentfwkFactoryImpl extends EFactoryImpl implements ContentfwkFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ContentfwkPackage.ENTERPRISE_ARCHITECTURE: return createEnterpriseArchitecture();
			case ContentfwkPackage.BUSINESS_ARCHITECTURE: return createBusinessArchitecture();
			case ContentfwkPackage.DATA_ARCHITECTURE: return createDataArchitecture();
			case ContentfwkPackage.TECHNOLOGY_ARCHITECTURE: return createTechnologyArchitecture();
			case ContentfwkPackage.DRIVER: return createDriver();
			case ContentfwkPackage.GOAL: return createGoal();
			case ContentfwkPackage.OBJECTIVE: return createObjective();
			case ContentfwkPackage.ORGANIZATION_UNIT: return createOrganizationUnit();
			case ContentfwkPackage.ACTOR: return createActor();
			case ContentfwkPackage.ROLE: return createRole();
			case ContentfwkPackage.DATA_ENTITY: return createDataEntity();
			case ContentfwkPackage.LOGICAL_APPLICATION_COMPONENT: return createLogicalApplicationComponent();
			case ContentfwkPackage.FUNCTION: return createFunction();
			case ContentfwkPackage.BUSINESS_SERVICE: return createBusinessService();
			case ContentfwkPackage.PROCESS: return createProcess();
			case ContentfwkPackage.PLATFORM_SERVICE: return createPlatformService();
			case ContentfwkPackage.PHYSICAL_TECHNOLOGY_COMPONENT: return createPhysicalTechnologyComponent();
			case ContentfwkPackage.PRODUCT: return createProduct();
			case ContentfwkPackage.MEASURE: return createMeasure();
			case ContentfwkPackage.SERVICE_QUALITY: return createServiceQuality();
			case ContentfwkPackage.CONTRACT: return createContract();
			case ContentfwkPackage.EVENT: return createEvent();
			case ContentfwkPackage.CONTROL: return createControl();
			case ContentfwkPackage.ELEMENT: return createElement();
			case ContentfwkPackage.CONTAINER: return createContainer();
			case ContentfwkPackage.LOCATION: return createLocation();
			case ContentfwkPackage.CAPABILITY: return createCapability();
			case ContentfwkPackage.PRINCIPLE: return createPrinciple();
			case ContentfwkPackage.CONSTRAINT: return createConstraint();
			case ContentfwkPackage.ASSUMPTION: return createAssumption();
			case ContentfwkPackage.REQUIREMENT: return createRequirement();
			case ContentfwkPackage.GAP: return createGap();
			case ContentfwkPackage.WORK_PACKAGE: return createWorkPackage();
			case ContentfwkPackage.LOGICAL_DATA_COMPONENT: return createLogicalDataComponent();
			case ContentfwkPackage.PHYSICAL_DATA_COMPONENT: return createPhysicalDataComponent();
			case ContentfwkPackage.APPLICATION_ARCHITECTURE: return createApplicationArchitecture();
			case ContentfwkPackage.PHYSICAL_APPLICATION_COMPONENT: return createPhysicalApplicationComponent();
			case ContentfwkPackage.LOGICAL_TECHNOLOGY_COMPONENT: return createLogicalTechnologyComponent();
			case ContentfwkPackage.STRATEGIC_ARCHITECTURE: return createStrategicArchitecture();
			case ContentfwkPackage.INFORMATION_SYSTEM_SERVICE: return createInformationSystemService();
			default:
