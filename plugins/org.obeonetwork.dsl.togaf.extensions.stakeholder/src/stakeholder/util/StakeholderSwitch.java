 ...
 * <!-- end-user-doc -->
 * @see stakeholder.StakeholderPackage
 * @generated
 */
public class StakeholderSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case StakeholderPackage.STAKEHOLDER: {
				...
				if (result == null) result = caseStrategicElement(stakeholder);
				if (result == null) result = caseElement(stakeholder);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StakeholderPackage.VALUE: {
				Value value = (Value)theEObject;
				T result = caseValue(value);
				if (result == null) result = caseStrategicElement(value);
