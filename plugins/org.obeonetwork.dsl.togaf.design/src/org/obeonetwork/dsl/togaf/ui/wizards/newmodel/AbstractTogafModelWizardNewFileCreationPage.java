 ...
 * @author ymortier
 */
public abstract class AbstractTogafModelWizardNewFileCreationPage extends WizardNewFileCreationPage {
	 ...
	 */
	public AbstractTogafModelWizardNewFileCreationPage(String pageName, IStructuredSelection selection) {
	...
	protected boolean validatePage() {
		if (super.validatePage()) {
			...
			if (enteredExt == null || !enteredExt.equals(requiredExt)) {
				setErrorMessage(Messages.bind(Messages.TogafModelWizard_UI_ErrorMsg_BadFileExtension,
						requiredExt));
				return false;
			} else {
				return true;
