...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.togaf.representations.Representation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RepresentationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RepresentationsPackage.Literals.REPRESENTATION__NAME,
				 true,
				 false,
				 false,
	...
	protected void addContentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Representation_content_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Representation_content_feature", "_UI_Representation_type"),
				 RepresentationsPackage.Literals.REPRESENTATION__CONTENT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Representation.class)) {
			case RepresentationsPackage.REPRESENTATION__NAME:
			case RepresentationsPackage.REPRESENTATION__CONTENT:
