 ...
 * $Id$
 */
package org.obeonetwork.dsl.layer.provider;
...
import org.obeonetwork.dsl.layer.LayerFactory;
import org.obeonetwork.dsl.layer.LayerPackage;

/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.layer.Layer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LayerItemProvider
	...
	protected void addReferencesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Layer_references_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Layer_references_feature", "_UI_Layer_type"),
				 LayerPackage.Literals.LAYER__REFERENCES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addElementsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Layer_elements_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Layer_elements_feature", "_UI_Layer_type"),
				 LayerPackage.Literals.LAYER__ELEMENTS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(LayerPackage.Literals.LAYER__SUB_LAYERS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(LayerPackage.Literals.LAYER__SUB_LAYERS,
				 LayerFactory.eINSTANCE.createLayer()));
	}
