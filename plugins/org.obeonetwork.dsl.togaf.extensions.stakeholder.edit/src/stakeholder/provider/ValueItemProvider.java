...
/**
 * This is the item provider adapter for a {@link stakeholder.Value} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Value_next_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Value_next_feature", "_UI_Value_type"),
				 StakeholderPackage.Literals.VALUE__NEXT,
				 true,
				 false,
				 true,
				 null,
