 ...
 * 
 */
public interface CapabilityPropertiesEditionPart {
	...
	/**
	 * Defines a new business Value
	 * @param newValue the new business Value to set
	 * 
	 */
	...
	/**
	 * Defines a new increments
	 * @param newValue the new increments to set
	 * 
	 */
	...
	/**
	 * @return the is Delivered By
	 * 
	 */
	public EObject getIsDeliveredBy();

	/**
	 * Init the is Delivered By
	 * @param settings the combo setting
	 */
	public void initIsDeliveredBy(EObjectFlatComboSettings settings);

	/**
	 * Defines a new is Delivered By
	 * @param newValue the new is Delivered By to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the is Delivered By edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
