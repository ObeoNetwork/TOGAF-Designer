...
public class ProcessPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, ProcessPropertiesEditionPart {
		...
		composer = new PartComposer(processStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == ContentfwkViewsRepository.Process.Attributes.processCritiality) {
					return 		createProcessCritialityText(widgetFactory, parent);
				}
				if (key == ContentfwkViewsRepository.Process.Attributes.isAutomated) {
					return createIsAutomatedCheckbox(widgetFactory, parent);
				}
				if (key == ContentfwkViewsRepository.Process.Attributes.processVolumetrics) {
					return 		createProcessVolumetricsText(widgetFactory, parent);
				}
				...
				if (key == ContentfwkViewsRepository.Process.RelatedElements.decomposesProcess) {
					return createDecomposesProcessFlatComboViewer(parent, widgetFactory);
				}
				if (key == ContentfwkViewsRepository.Process.RelatedElements.precedesProcesses) {
					return createPrecedesProcessesReferencesTable(widgetFactory, parent);
				}
				if (key == ContentfwkViewsRepository.Process.RelatedElements.followsProcesses) {
					return createFollowsProcessesReferencesTable(widgetFactory, parent);
				}
				...
				if (key == ContentfwkViewsRepository.Process.RelatedElements.generatesEvents) {
					return createGeneratesEventsReferencesTable(widgetFactory, parent);
				}
				if (key == ContentfwkViewsRepository.Process.RelatedElements.orchestratesFunctions) {
					return createOrchestratesFunctionsReferencesTable(widgetFactory, parent);
				}
				if (key == ContentfwkViewsRepository.Process.RelatedElements.decomposesFunctions) {
					return createDecomposesFunctionsReferencesTable(widgetFactory, parent);
				}
				if (key == ContentfwkViewsRepository.Process.RelatedElements.involvesOrganizationUnits) {
					return createInvolvesOrganizationUnitsReferencesTable(widgetFactory, parent);
				}
				if (key == ContentfwkViewsRepository.Process.RelatedElements.orchestratesServices) {
					return createOrchestratesServicesReferencesTable(widgetFactory, parent);
				}
				...
				if (key == ContentfwkViewsRepository.Process.RelatedElements.involvesActors) {
					return createInvolvesActorsReferencesTable(widgetFactory, parent);
				}
				if (key == ContentfwkViewsRepository.Process.RelatedElements.isGuidedByControls) {
					return createIsGuidedByControlsReferencesTable(widgetFactory, parent);
				}
	...
	protected Composite createAttributesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		attributesSection.setText(ContentfwkMessages.ProcessPropertiesEditionPart_AttributesGroupLabel);
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.ProcessPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.Process.Attributes.name, ContentfwkViewsRepository.FORM_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.Attributes.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.Process.Attributes.name, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createIDText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.ProcessPropertiesEditionPart_IDLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.Process.Attributes.iD, ContentfwkViewsRepository.FORM_KIND));
		...
		iD.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.Attributes.iD, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, iD.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.Process.Attributes.iD, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.ProcessPropertiesEditionPart_DescriptionLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.Process.Attributes.description, ContentfwkViewsRepository.FORM_KIND));
		...
		description.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.Attributes.description, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, description.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.Process.Attributes.description, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createCategoryText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.ProcessPropertiesEditionPart_CategoryLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.Process.Attributes.category, ContentfwkViewsRepository.FORM_KIND));
		...
		category.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.Attributes.category, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, category.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.Process.Attributes.category, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createSourceText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.ProcessPropertiesEditionPart_SourceLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.Process.Attributes.source, ContentfwkViewsRepository.FORM_KIND));
		...
		source.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.Attributes.source, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, source.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.Process.Attributes.source, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createOwnerText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.ProcessPropertiesEditionPart_OwnerLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.Process.Attributes.owner, ContentfwkViewsRepository.FORM_KIND));
		...
		owner.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.Attributes.owner, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, owner.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.Process.Attributes.owner, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createStandardClassEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.ProcessPropertiesEditionPart_StandardClassLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.Process.Attributes.standardClass, ContentfwkViewsRepository.FORM_KIND));
		...
		standardClass.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.Attributes.standardClass, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getStandardClass()));
			}

		});
		standardClass.setID(ContentfwkViewsRepository.Process.Attributes.standardClass);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.Process.Attributes.standardClass, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createStandardCreationDateText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.ProcessPropertiesEditionPart_StandardCreationDateLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.Process.Attributes.standardCreationDate, ContentfwkViewsRepository.FORM_KIND));
		...
		standardCreationDate.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.Attributes.standardCreationDate, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, standardCreationDate.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.Process.Attributes.standardCreationDate, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createLastStandardCreationDateText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.ProcessPropertiesEditionPart_LastStandardCreationDateLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.Process.Attributes.lastStandardCreationDate, ContentfwkViewsRepository.FORM_KIND));
		...
		lastStandardCreationDate.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.Attributes.lastStandardCreationDate, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, lastStandardCreationDate.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.Process.Attributes.lastStandardCreationDate, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createNextStandardCreationDateText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.ProcessPropertiesEditionPart_NextStandardCreationDateLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.Process.Attributes.nextStandardCreationDate, ContentfwkViewsRepository.FORM_KIND));
		...
		nextStandardCreationDate.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.Attributes.nextStandardCreationDate, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, nextStandardCreationDate.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.Process.Attributes.nextStandardCreationDate, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createRetireDateText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.ProcessPropertiesEditionPart_RetireDateLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.Process.Attributes.retireDate, ContentfwkViewsRepository.FORM_KIND));
		...
		retireDate.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.Attributes.retireDate, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, retireDate.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.Process.Attributes.retireDate, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createProcessCritialityText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.ProcessPropertiesEditionPart_ProcessCritialityLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.Process.Attributes.processCritiality, ContentfwkViewsRepository.FORM_KIND));
		processCritiality = widgetFactory.createText(parent, ""); //$NON-NLS-1$
		processCritiality.setData(FormToolkit.KEY_DRAW_BORDER, FormToolkit.TEXT_BORDER);
		widgetFactory.paintBordersFor(parent);
		...
		processCritiality.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.Attributes.processCritiality, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, processCritiality.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.Process.Attributes.processCritiality, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createIsAutomatedCheckbox(FormToolkit widgetFactory, Composite parent) {
		isAutomated = widgetFactory.createButton(parent, ContentfwkMessages.ProcessPropertiesEditionPart_IsAutomatedLabel, SWT.CHECK);
		isAutomated.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.Attributes.isAutomated, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(isAutomated.getSelection())));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.Process.Attributes.isAutomated, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createProcessVolumetricsText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.ProcessPropertiesEditionPart_ProcessVolumetricsLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.Process.Attributes.processVolumetrics, ContentfwkViewsRepository.FORM_KIND));
		processVolumetrics = widgetFactory.createText(parent, ""); //$NON-NLS-1$
		processVolumetrics.setData(FormToolkit.KEY_DRAW_BORDER, FormToolkit.TEXT_BORDER);
		widgetFactory.paintBordersFor(parent);
		...
		processVolumetrics.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.Attributes.processVolumetrics, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, processVolumetrics.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.Process.Attributes.processVolumetrics, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createRelatedElementsGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		relatedElementsSection.setText(ContentfwkMessages.ProcessPropertiesEditionPart_RelatedElementsGroupLabel);
	 ...
	 * 
	 */
	protected Composite createDecomposesProcessFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.ProcessPropertiesEditionPart_DecomposesProcessLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.Process.RelatedElements.decomposesProcess, ContentfwkViewsRepository.FORM_KIND));
		decomposesProcess = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(ContentfwkViewsRepository.Process.RelatedElements.decomposesProcess, ContentfwkViewsRepository.FORM_KIND));
		widgetFactory.adapt(decomposesProcess);
		...
		decomposesProcess.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.decomposesProcess, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getDecomposesProcess()));
			}

		});
		decomposesProcess.setID(ContentfwkViewsRepository.Process.RelatedElements.decomposesProcess);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.Process.RelatedElements.decomposesProcess, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * 
	 */
	protected Composite createPrecedesProcessesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.precedesProcesses.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.Process.RelatedElements.precedesProcesses, ContentfwkViewsRepository.FORM_KIND));
		this.precedesProcesses.createControls(parent, widgetFactory);
		this.precedesProcesses.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.precedesProcesses, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"precedes Processes", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.precedesProcesses,
	...
	protected void movePrecedesProcesses(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.precedesProcesses, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		precedesProcesses.refresh();
	}
	...
	protected void removeFromPrecedesProcesses(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.precedesProcesses, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		precedesProcesses.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createFollowsProcessesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.followsProcesses.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.Process.RelatedElements.followsProcesses, ContentfwkViewsRepository.FORM_KIND));
		this.followsProcesses.createControls(parent, widgetFactory);
		this.followsProcesses.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.followsProcesses, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addFollowsProcesses() {
		...
		"follows Processes", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.followsProcesses,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveFollowsProcesses(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.followsProcesses, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		followsProcesses.refresh();
	}
	...
	protected void removeFromFollowsProcesses(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.followsProcesses, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		followsProcesses.refresh();
	}
	...
	protected Composite createResolvesEventsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.resolvesEvents.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.Process.RelatedElements.resolvesEvents, ContentfwkViewsRepository.FORM_KIND));
		this.resolvesEvents.createControls(parent, widgetFactory);
		this.resolvesEvents.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.resolvesEvents, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addResolvesEvents() {
		...
		"resolves Events", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.resolvesEvents,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveResolvesEvents(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.resolvesEvents, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		resolvesEvents.refresh();
	}
	...
	protected void removeFromResolvesEvents(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.resolvesEvents, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		resolvesEvents.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createGeneratesEventsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.generatesEvents.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.Process.RelatedElements.generatesEvents, ContentfwkViewsRepository.FORM_KIND));
		this.generatesEvents.createControls(parent, widgetFactory);
		this.generatesEvents.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.generatesEvents, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addGeneratesEvents() {
		...
		"generates Events", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.generatesEvents,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveGeneratesEvents(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.generatesEvents, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		generatesEvents.refresh();
	}
	...
	protected void removeFromGeneratesEvents(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.generatesEvents, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		generatesEvents.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createOrchestratesFunctionsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.orchestratesFunctions.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.Process.RelatedElements.orchestratesFunctions, ContentfwkViewsRepository.FORM_KIND));
		this.orchestratesFunctions.createControls(parent, widgetFactory);
		this.orchestratesFunctions.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.orchestratesFunctions, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addOrchestratesFunctions() {
		...
		"orchestrates Functions", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.orchestratesFunctions,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveOrchestratesFunctions(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.orchestratesFunctions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		orchestratesFunctions.refresh();
	}
	...
	protected void removeFromOrchestratesFunctions(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.orchestratesFunctions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		orchestratesFunctions.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createDecomposesFunctionsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.decomposesFunctions.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.Process.RelatedElements.decomposesFunctions, ContentfwkViewsRepository.FORM_KIND));
		this.decomposesFunctions.createControls(parent, widgetFactory);
		this.decomposesFunctions.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.decomposesFunctions, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addDecomposesFunctions() {
		...
		"decomposes Functions", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.decomposesFunctions,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveDecomposesFunctions(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.decomposesFunctions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		decomposesFunctions.refresh();
	}
	...
	protected void removeFromDecomposesFunctions(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.decomposesFunctions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		decomposesFunctions.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createInvolvesOrganizationUnitsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.involvesOrganizationUnits.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.Process.RelatedElements.involvesOrganizationUnits, ContentfwkViewsRepository.FORM_KIND));
		this.involvesOrganizationUnits.createControls(parent, widgetFactory);
		this.involvesOrganizationUnits.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.involvesOrganizationUnits, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addInvolvesOrganizationUnits() {
		...
		"involves Organization Units", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.involvesOrganizationUnits,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveInvolvesOrganizationUnits(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.involvesOrganizationUnits, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		involvesOrganizationUnits.refresh();
	}
	...
	protected void removeFromInvolvesOrganizationUnits(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.involvesOrganizationUnits, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		involvesOrganizationUnits.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createOrchestratesServicesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.orchestratesServices.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.Process.RelatedElements.orchestratesServices, ContentfwkViewsRepository.FORM_KIND));
		this.orchestratesServices.createControls(parent, widgetFactory);
		this.orchestratesServices.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.orchestratesServices, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addOrchestratesServices() {
		...
		"orchestrates Services", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.orchestratesServices,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveOrchestratesServices(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.orchestratesServices, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		orchestratesServices.refresh();
	}
	...
	protected void removeFromOrchestratesServices(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.orchestratesServices, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		orchestratesServices.refresh();
	}
	...
	protected Composite createDecomposesServicesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.decomposesServices.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.Process.RelatedElements.decomposesServices, ContentfwkViewsRepository.FORM_KIND));
		...
		this.decomposesServices.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.decomposesServices, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addDecomposesServices() {
		...
		"decomposes Services", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.decomposesServices,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveDecomposesServices(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.decomposesServices, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		decomposesServices.refresh();
	}
	...
	protected void removeFromDecomposesServices(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.decomposesServices, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		decomposesServices.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createInvolvesActorsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.involvesActors.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.Process.RelatedElements.involvesActors, ContentfwkViewsRepository.FORM_KIND));
		this.involvesActors.createControls(parent, widgetFactory);
		this.involvesActors.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.involvesActors, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addInvolvesActors() {
		...
		"involves Actors", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.involvesActors,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveInvolvesActors(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.involvesActors, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		involvesActors.refresh();
	}
	...
	protected void removeFromInvolvesActors(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.involvesActors, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		involvesActors.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createIsGuidedByControlsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.isGuidedByControls.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.Process.RelatedElements.isGuidedByControls, ContentfwkViewsRepository.FORM_KIND));
		this.isGuidedByControls.createControls(parent, widgetFactory);
		this.isGuidedByControls.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.isGuidedByControls, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addIsGuidedByControls() {
		...
		"is Guided By Controls", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.isGuidedByControls,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveIsGuidedByControls(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.isGuidedByControls, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		isGuidedByControls.refresh();
	}
	...
	protected void removeFromIsGuidedByControls(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.isGuidedByControls, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		isGuidedByControls.refresh();
	}
	...
	protected Composite createProducesProductsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.producesProducts.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.Process.RelatedElements.producesProducts, ContentfwkViewsRepository.FORM_KIND));
		this.producesProducts.createControls(parent, widgetFactory);
		this.producesProducts.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.producesProducts, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addProducesProducts() {
		...
		"produces Products", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.producesProducts,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveProducesProducts(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.producesProducts, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		producesProducts.refresh();
	}
	...
	protected void removeFromProducesProducts(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.producesProducts, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		producesProducts.refresh();
	}
	...
	protected Composite createDelegatesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.delegates.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.Process.RelatedElements.delegates, ContentfwkViewsRepository.FORM_KIND));
		this.delegates.createControls(parent, widgetFactory);
		this.delegates.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.delegates, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addDelegates() {
		...
		"delegates", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.delegates,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				delegates.refresh();
			}
	...
	protected void moveDelegates(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.delegates, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		delegates.refresh();
	}
	...
	protected void removeFromDelegates(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.delegates, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		delegates.refresh();
	}
	...
	protected Composite createIsDelegatedByReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.isDelegatedBy.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.Process.RelatedElements.isDelegatedBy, ContentfwkViewsRepository.FORM_KIND));
		this.isDelegatedBy.createControls(parent, widgetFactory);
		this.isDelegatedBy.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.isDelegatedBy, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addIsDelegatedBy() {
		...
		"is Delegated By", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.isDelegatedBy,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveIsDelegatedBy(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.isDelegatedBy, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		isDelegatedBy.refresh();
	}
	...
	protected void removeFromIsDelegatedBy(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, ContentfwkViewsRepository.Process.RelatedElements.isDelegatedBy, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		isDelegatedBy.refresh();
	}
