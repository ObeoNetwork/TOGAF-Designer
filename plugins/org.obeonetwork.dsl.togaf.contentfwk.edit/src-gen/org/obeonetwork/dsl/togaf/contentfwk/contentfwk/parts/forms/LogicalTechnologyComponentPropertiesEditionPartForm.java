 ...
 * 
 */
public class LogicalTechnologyComponentPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, LogicalTechnologyComponentPropertiesEditionPart {
	 ...
	 * 
	 */
	public LogicalTechnologyComponentPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(logicalTechnologyComponentStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == ContentfwkViewsRepository.LogicalTechnologyComponent.RelatedElements.decomposesLogicalTechnologyComponent) {
					return createDecomposesLogicalTechnologyComponentFlatComboViewer(parent, widgetFactory);
				}
				...
				if (key == ContentfwkViewsRepository.LogicalTechnologyComponent.RelatedElements.isDependentOnLogicalTechnologyComponents) {
					return createIsDependentOnLogicalTechnologyComponentsReferencesTable(widgetFactory, parent);
				}
				if (key == ContentfwkViewsRepository.LogicalTechnologyComponent.RelatedElements.providesPlatformForServices) {
					return createProvidesPlatformForServicesReferencesTable(widgetFactory, parent);
				}
				if (key == ContentfwkViewsRepository.LogicalTechnologyComponent.RelatedElements.suppliesPlatformServices) {
					return createSuppliesPlatformServicesReferencesTable(widgetFactory, parent);
				}
	...
	protected Composite createAttributesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		attributesSection.setText(ContentfwkMessages.LogicalTechnologyComponentPropertiesEditionPart_AttributesGroupLabel);
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.LogicalTechnologyComponentPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.LogicalTechnologyComponent.Attributes.name, ContentfwkViewsRepository.FORM_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.LogicalTechnologyComponent.Attributes.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.LogicalTechnologyComponent.Attributes.name, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createIDText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.LogicalTechnologyComponentPropertiesEditionPart_IDLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.LogicalTechnologyComponent.Attributes.iD, ContentfwkViewsRepository.FORM_KIND));
		...
		iD.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.LogicalTechnologyComponent.Attributes.iD, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, iD.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.LogicalTechnologyComponent.Attributes.iD, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.LogicalTechnologyComponentPropertiesEditionPart_DescriptionLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.LogicalTechnologyComponent.Attributes.description, ContentfwkViewsRepository.FORM_KIND));
		...
		description.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.LogicalTechnologyComponent.Attributes.description, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, description.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.LogicalTechnologyComponent.Attributes.description, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createCategoryText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.LogicalTechnologyComponentPropertiesEditionPart_CategoryLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.LogicalTechnologyComponent.Attributes.category, ContentfwkViewsRepository.FORM_KIND));
		...
		category.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.LogicalTechnologyComponent.Attributes.category, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, category.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.LogicalTechnologyComponent.Attributes.category, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createSourceText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.LogicalTechnologyComponentPropertiesEditionPart_SourceLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.LogicalTechnologyComponent.Attributes.source, ContentfwkViewsRepository.FORM_KIND));
		...
		source.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.LogicalTechnologyComponent.Attributes.source, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, source.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.LogicalTechnologyComponent.Attributes.source, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createOwnerText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.LogicalTechnologyComponentPropertiesEditionPart_OwnerLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.LogicalTechnologyComponent.Attributes.owner, ContentfwkViewsRepository.FORM_KIND));
		...
		owner.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.LogicalTechnologyComponent.Attributes.owner, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, owner.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.LogicalTechnologyComponent.Attributes.owner, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createStandardClassEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.LogicalTechnologyComponentPropertiesEditionPart_StandardClassLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.LogicalTechnologyComponent.Attributes.standardClass, ContentfwkViewsRepository.FORM_KIND));
		...
		standardClass.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.LogicalTechnologyComponent.Attributes.standardClass, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getStandardClass()));
			}

		});
		standardClass.setID(ContentfwkViewsRepository.LogicalTechnologyComponent.Attributes.standardClass);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.LogicalTechnologyComponent.Attributes.standardClass, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createStandardCreationDateText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.LogicalTechnologyComponentPropertiesEditionPart_StandardCreationDateLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.LogicalTechnologyComponent.Attributes.standardCreationDate, ContentfwkViewsRepository.FORM_KIND));
		...
		standardCreationDate.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.LogicalTechnologyComponent.Attributes.standardCreationDate, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, standardCreationDate.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.LogicalTechnologyComponent.Attributes.standardCreationDate, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createLastStandardCreationDateText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.LogicalTechnologyComponentPropertiesEditionPart_LastStandardCreationDateLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.LogicalTechnologyComponent.Attributes.lastStandardCreationDate, ContentfwkViewsRepository.FORM_KIND));
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.LogicalTechnologyComponent.Attributes.lastStandardCreationDate, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createNextStandardCreationDateText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.LogicalTechnologyComponentPropertiesEditionPart_NextStandardCreationDateLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.LogicalTechnologyComponent.Attributes.nextStandardCreationDate, ContentfwkViewsRepository.FORM_KIND));
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.LogicalTechnologyComponent.Attributes.nextStandardCreationDate, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createRetireDateText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.LogicalTechnologyComponentPropertiesEditionPart_RetireDateLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.LogicalTechnologyComponent.Attributes.retireDate, ContentfwkViewsRepository.FORM_KIND));
		...
		retireDate.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.LogicalTechnologyComponent.Attributes.retireDate, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, retireDate.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.LogicalTechnologyComponent.Attributes.retireDate, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createRelatedElementsGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		relatedElementsSection.setText(ContentfwkMessages.LogicalTechnologyComponentPropertiesEditionPart_RelatedElementsGroupLabel);
	 ...
	 * 
	 */
	protected Composite createDecomposesLogicalTechnologyComponentFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.LogicalTechnologyComponentPropertiesEditionPart_DecomposesLogicalTechnologyComponentLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.LogicalTechnologyComponent.RelatedElements.decomposesLogicalTechnologyComponent, ContentfwkViewsRepository.FORM_KIND));
		decomposesLogicalTechnologyComponent = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(ContentfwkViewsRepository.LogicalTechnologyComponent.RelatedElements.decomposesLogicalTechnologyComponent, ContentfwkViewsRepository.FORM_KIND));
		widgetFactory.adapt(decomposesLogicalTechnologyComponent);
		...
		decomposesLogicalTechnologyComponent.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.LogicalTechnologyComponent.RelatedElements.decomposesLogicalTechnologyComponent, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getDecomposesLogicalTechnologyComponent()));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.LogicalTechnologyComponent.RelatedElements.decomposesLogicalTechnologyComponent, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createIsRealizedByPhysicalTechnologyComponentsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.isRealizedByPhysicalTechnologyComponents.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.LogicalTechnologyComponent.RelatedElements.isRealizedByPhysicalTechnologyComponents, ContentfwkViewsRepository.FORM_KIND));
		...
		"is Realized By Physical Technology Components", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.LogicalTechnologyComponent.RelatedElements.isRealizedByPhysicalTechnologyComponents,
	 ...
	 * 
	 */
	protected Composite createIsDependentOnLogicalTechnologyComponentsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.isDependentOnLogicalTechnologyComponents.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.LogicalTechnologyComponent.RelatedElements.isDependentOnLogicalTechnologyComponents, ContentfwkViewsRepository.FORM_KIND));
		this.isDependentOnLogicalTechnologyComponents.createControls(parent, widgetFactory);
	...
	protected void addIsDependentOnLogicalTechnologyComponents() {
		...
		"is Dependent On Logical Technology Components", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.LogicalTechnologyComponent.RelatedElements.isDependentOnLogicalTechnologyComponents,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	 ...
	 * 
	 */
	protected Composite createProvidesPlatformForServicesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.providesPlatformForServices.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.LogicalTechnologyComponent.RelatedElements.providesPlatformForServices, ContentfwkViewsRepository.FORM_KIND));
		this.providesPlatformForServices.createControls(parent, widgetFactory);
	...
	protected void addProvidesPlatformForServices() {
		...
		"provides Platform For Services", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.LogicalTechnologyComponent.RelatedElements.providesPlatformForServices,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	 ...
	 * 
	 */
	protected Composite createSuppliesPlatformServicesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.suppliesPlatformServices.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.LogicalTechnologyComponent.RelatedElements.suppliesPlatformServices, ContentfwkViewsRepository.FORM_KIND));
		this.suppliesPlatformServices.createControls(parent, widgetFactory);
	...
	protected void addSuppliesPlatformServices() {
		...
		"supplies Platform Services", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.LogicalTechnologyComponent.RelatedElements.suppliesPlatformServices,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void removeFromSuppliesPlatformServices(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.LogicalTechnologyComponent.RelatedElements.suppliesPlatformServices, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		suppliesPlatformServices.refresh();
	}
	...
	protected Composite createDelegatesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.delegates.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.LogicalTechnologyComponent.RelatedElements.delegates, ContentfwkViewsRepository.FORM_KIND));
	...
	protected void addDelegates() {
		...
		"delegates", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.LogicalTechnologyComponent.RelatedElements.delegates,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				delegates.refresh();
			}
	...
	protected void moveDelegates(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.LogicalTechnologyComponent.RelatedElements.delegates, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		delegates.refresh();
	}
	...
	protected void removeFromDelegates(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.LogicalTechnologyComponent.RelatedElements.delegates, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		delegates.refresh();
	}
	...
	protected Composite createIsDelegatedByReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.isDelegatedBy.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.LogicalTechnologyComponent.RelatedElements.isDelegatedBy, ContentfwkViewsRepository.FORM_KIND));
	...
	protected void addIsDelegatedBy() {
		...
		"is Delegated By", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.LogicalTechnologyComponent.RelatedElements.isDelegatedBy,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveIsDelegatedBy(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.LogicalTechnologyComponent.RelatedElements.isDelegatedBy, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		isDelegatedBy.refresh();
	}
	...
	protected void removeFromIsDelegatedBy(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.LogicalTechnologyComponent.RelatedElements.isDelegatedBy, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		isDelegatedBy.refresh();
	}
