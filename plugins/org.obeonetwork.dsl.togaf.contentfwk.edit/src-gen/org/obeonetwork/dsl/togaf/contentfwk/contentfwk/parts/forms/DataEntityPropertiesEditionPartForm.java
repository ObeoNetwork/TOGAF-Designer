 ...
 * 
 */
public class DataEntityPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, DataEntityPropertiesEditionPart {
	 ...
	 * 
	 */
	public DataEntityPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(dataEntityStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == ContentfwkViewsRepository.DataEntity.Attributes.dataEntityCategory) {
					return createDataEntityCategoryEMFComboViewer(widgetFactory, parent);
				}
				if (key == ContentfwkViewsRepository.DataEntity.Attributes.privacyClassification) {
					return 		createPrivacyClassificationText(widgetFactory, parent);
				}
				if (key == ContentfwkViewsRepository.DataEntity.Attributes.retentionClassification) {
					return 		createRetentionClassificationText(widgetFactory, parent);
				}
	...
	protected Composite createAttributesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		attributesSection.setText(ContentfwkMessages.DataEntityPropertiesEditionPart_AttributesGroupLabel);
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.DataEntityPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.DataEntity.Attributes.name, ContentfwkViewsRepository.FORM_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityPropertiesEditionPartForm.this, ContentfwkViewsRepository.DataEntity.Attributes.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.DataEntity.Attributes.name, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createIDText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.DataEntityPropertiesEditionPart_IDLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.DataEntity.Attributes.iD, ContentfwkViewsRepository.FORM_KIND));
		...
		iD.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityPropertiesEditionPartForm.this, ContentfwkViewsRepository.DataEntity.Attributes.iD, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, iD.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.DataEntity.Attributes.iD, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.DataEntityPropertiesEditionPart_DescriptionLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.DataEntity.Attributes.description, ContentfwkViewsRepository.FORM_KIND));
		...
		description.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityPropertiesEditionPartForm.this, ContentfwkViewsRepository.DataEntity.Attributes.description, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, description.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.DataEntity.Attributes.description, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createCategoryText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.DataEntityPropertiesEditionPart_CategoryLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.DataEntity.Attributes.category, ContentfwkViewsRepository.FORM_KIND));
		...
		category.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityPropertiesEditionPartForm.this, ContentfwkViewsRepository.DataEntity.Attributes.category, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, category.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.DataEntity.Attributes.category, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createSourceText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.DataEntityPropertiesEditionPart_SourceLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.DataEntity.Attributes.source, ContentfwkViewsRepository.FORM_KIND));
		...
		source.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityPropertiesEditionPartForm.this, ContentfwkViewsRepository.DataEntity.Attributes.source, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, source.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.DataEntity.Attributes.source, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createOwnerText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.DataEntityPropertiesEditionPart_OwnerLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.DataEntity.Attributes.owner, ContentfwkViewsRepository.FORM_KIND));
		...
		owner.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityPropertiesEditionPartForm.this, ContentfwkViewsRepository.DataEntity.Attributes.owner, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, owner.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.DataEntity.Attributes.owner, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createDataEntityCategoryEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.DataEntityPropertiesEditionPart_DataEntityCategoryLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.DataEntity.Attributes.dataEntityCategory, ContentfwkViewsRepository.FORM_KIND));
		...
		dataEntityCategory.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityPropertiesEditionPartForm.this, ContentfwkViewsRepository.DataEntity.Attributes.dataEntityCategory, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getDataEntityCategory()));
			}

		});
		dataEntityCategory.setID(ContentfwkViewsRepository.DataEntity.Attributes.dataEntityCategory);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.DataEntity.Attributes.dataEntityCategory, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createPrivacyClassificationText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.DataEntityPropertiesEditionPart_PrivacyClassificationLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.DataEntity.Attributes.privacyClassification, ContentfwkViewsRepository.FORM_KIND));
		privacyClassification = widgetFactory.createText(parent, ""); //$NON-NLS-1$
		privacyClassification.setData(FormToolkit.KEY_DRAW_BORDER, FormToolkit.TEXT_BORDER);
		widgetFactory.paintBordersFor(parent);
		...
		privacyClassification.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityPropertiesEditionPartForm.this, ContentfwkViewsRepository.DataEntity.Attributes.privacyClassification, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, privacyClassification.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.DataEntity.Attributes.privacyClassification, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createRetentionClassificationText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.DataEntityPropertiesEditionPart_RetentionClassificationLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.DataEntity.Attributes.retentionClassification, ContentfwkViewsRepository.FORM_KIND));
		retentionClassification = widgetFactory.createText(parent, ""); //$NON-NLS-1$
		retentionClassification.setData(FormToolkit.KEY_DRAW_BORDER, FormToolkit.TEXT_BORDER);
		widgetFactory.paintBordersFor(parent);
		...
		retentionClassification.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityPropertiesEditionPartForm.this, ContentfwkViewsRepository.DataEntity.Attributes.retentionClassification, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, retentionClassification.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.DataEntity.Attributes.retentionClassification, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createRelatedElementsGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		relatedElementsSection.setText(ContentfwkMessages.DataEntityPropertiesEditionPart_RelatedElementsGroupLabel);
	 ...
	 * 
	 */
	protected Composite createDecomposeEntityFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.DataEntityPropertiesEditionPart_DecomposeEntityLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.DataEntity.RelatedElements.decomposeEntity, ContentfwkViewsRepository.FORM_KIND));
		decomposeEntity = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(ContentfwkViewsRepository.DataEntity.RelatedElements.decomposeEntity, ContentfwkViewsRepository.FORM_KIND));
		widgetFactory.adapt(decomposeEntity);
		...
		decomposeEntity.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityPropertiesEditionPartForm.this, ContentfwkViewsRepository.DataEntity.RelatedElements.decomposeEntity, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getDecomposeEntity()));
			}

		});
		decomposeEntity.setID(ContentfwkViewsRepository.DataEntity.RelatedElements.decomposeEntity);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.DataEntity.RelatedElements.decomposeEntity, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * 
	 */
	protected Composite createRelatesToReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.relatesTo.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.DataEntity.RelatedElements.relatesTo, ContentfwkViewsRepository.FORM_KIND));
		this.relatesTo.createControls(parent, widgetFactory);
		this.relatesTo.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityPropertiesEditionPartForm.this, ContentfwkViewsRepository.DataEntity.RelatedElements.relatesTo, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"relates To", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityPropertiesEditionPartForm.this, ContentfwkViewsRepository.DataEntity.RelatedElements.relatesTo,
	...
	protected void moveRelatesTo(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityPropertiesEditionPartForm.this, ContentfwkViewsRepository.DataEntity.RelatedElements.relatesTo, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		relatesTo.refresh();
	}
	...
	protected void removeFromRelatesTo(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityPropertiesEditionPartForm.this, ContentfwkViewsRepository.DataEntity.RelatedElements.relatesTo, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		relatesTo.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createResidesWithinLogicalDataComponentFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.DataEntityPropertiesEditionPart_ResidesWithinLogicalDataComponentLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.DataEntity.RelatedElements.residesWithinLogicalDataComponent, ContentfwkViewsRepository.FORM_KIND));
		residesWithinLogicalDataComponent = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(ContentfwkViewsRepository.DataEntity.RelatedElements.residesWithinLogicalDataComponent, ContentfwkViewsRepository.FORM_KIND));
		widgetFactory.adapt(residesWithinLogicalDataComponent);
		...
		residesWithinLogicalDataComponent.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityPropertiesEditionPartForm.this, ContentfwkViewsRepository.DataEntity.RelatedElements.residesWithinLogicalDataComponent, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getResidesWithinLogicalDataComponent()));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.DataEntity.RelatedElements.residesWithinLogicalDataComponent, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * 
	 */
	protected Composite createIsProcessesByLogicalApplicationComponentsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.isProcessesByLogicalApplicationComponents.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.DataEntity.RelatedElements.isProcessesByLogicalApplicationComponents, ContentfwkViewsRepository.FORM_KIND));
		this.isProcessesByLogicalApplicationComponents.createControls(parent, widgetFactory);
	...
	protected void addIsProcessesByLogicalApplicationComponents() {
		...
		"is Processes By Logical Application Components", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityPropertiesEditionPartForm.this, ContentfwkViewsRepository.DataEntity.RelatedElements.isProcessesByLogicalApplicationComponents,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveIsProcessesByLogicalApplicationComponents(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityPropertiesEditionPartForm.this, ContentfwkViewsRepository.DataEntity.RelatedElements.isProcessesByLogicalApplicationComponents, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		isProcessesByLogicalApplicationComponents.refresh();
	}
	...
	protected void removeFromIsProcessesByLogicalApplicationComponents(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityPropertiesEditionPartForm.this, ContentfwkViewsRepository.DataEntity.RelatedElements.isProcessesByLogicalApplicationComponents, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		isProcessesByLogicalApplicationComponents.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createIsSuppliedByActorsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.isSuppliedByActors.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.DataEntity.RelatedElements.isSuppliedByActors, ContentfwkViewsRepository.FORM_KIND));
		this.isSuppliedByActors.createControls(parent, widgetFactory);
		this.isSuppliedByActors.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityPropertiesEditionPartForm.this, ContentfwkViewsRepository.DataEntity.RelatedElements.isSuppliedByActors, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addIsSuppliedByActors() {
		...
		"is Supplied By Actors", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityPropertiesEditionPartForm.this, ContentfwkViewsRepository.DataEntity.RelatedElements.isSuppliedByActors,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveIsSuppliedByActors(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityPropertiesEditionPartForm.this, ContentfwkViewsRepository.DataEntity.RelatedElements.isSuppliedByActors, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		isSuppliedByActors.refresh();
	}
	...
	protected void removeFromIsSuppliedByActors(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityPropertiesEditionPartForm.this, ContentfwkViewsRepository.DataEntity.RelatedElements.isSuppliedByActors, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		isSuppliedByActors.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createIsConsumedByActorsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.isConsumedByActors.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.DataEntity.RelatedElements.isConsumedByActors, ContentfwkViewsRepository.FORM_KIND));
		this.isConsumedByActors.createControls(parent, widgetFactory);
		this.isConsumedByActors.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityPropertiesEditionPartForm.this, ContentfwkViewsRepository.DataEntity.RelatedElements.isConsumedByActors, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addIsConsumedByActors() {
		...
		"is Consumed By Actors", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityPropertiesEditionPartForm.this, ContentfwkViewsRepository.DataEntity.RelatedElements.isConsumedByActors,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveIsConsumedByActors(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityPropertiesEditionPartForm.this, ContentfwkViewsRepository.DataEntity.RelatedElements.isConsumedByActors, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		isConsumedByActors.refresh();
	}
	...
	protected void removeFromIsConsumedByActors(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityPropertiesEditionPartForm.this, ContentfwkViewsRepository.DataEntity.RelatedElements.isConsumedByActors, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		isConsumedByActors.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createIsAccessedByServicesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.isAccessedByServices.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.DataEntity.RelatedElements.isAccessedByServices, ContentfwkViewsRepository.FORM_KIND));
		this.isAccessedByServices.createControls(parent, widgetFactory);
		this.isAccessedByServices.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityPropertiesEditionPartForm.this, ContentfwkViewsRepository.DataEntity.RelatedElements.isAccessedByServices, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addIsAccessedByServices() {
		...
		"is Accessed By Services", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityPropertiesEditionPartForm.this, ContentfwkViewsRepository.DataEntity.RelatedElements.isAccessedByServices,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveIsAccessedByServices(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityPropertiesEditionPartForm.this, ContentfwkViewsRepository.DataEntity.RelatedElements.isAccessedByServices, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		isAccessedByServices.refresh();
	}
	...
	protected void removeFromIsAccessedByServices(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityPropertiesEditionPartForm.this, ContentfwkViewsRepository.DataEntity.RelatedElements.isAccessedByServices, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		isAccessedByServices.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createIsUpdatedThroughServicesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.isUpdatedThroughServices.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.DataEntity.RelatedElements.isUpdatedThroughServices, ContentfwkViewsRepository.FORM_KIND));
		this.isUpdatedThroughServices.createControls(parent, widgetFactory);
		this.isUpdatedThroughServices.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityPropertiesEditionPartForm.this, ContentfwkViewsRepository.DataEntity.RelatedElements.isUpdatedThroughServices, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addIsUpdatedThroughServices() {
		...
		"is Updated Through Services", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityPropertiesEditionPartForm.this, ContentfwkViewsRepository.DataEntity.RelatedElements.isUpdatedThroughServices,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveIsUpdatedThroughServices(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityPropertiesEditionPartForm.this, ContentfwkViewsRepository.DataEntity.RelatedElements.isUpdatedThroughServices, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		isUpdatedThroughServices.refresh();
	}
	...
	protected void removeFromIsUpdatedThroughServices(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityPropertiesEditionPartForm.this, ContentfwkViewsRepository.DataEntity.RelatedElements.isUpdatedThroughServices, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		isUpdatedThroughServices.refresh();
	}
	...
	protected Composite createDelegatesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.delegates.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.DataEntity.RelatedElements.delegates, ContentfwkViewsRepository.FORM_KIND));
		this.delegates.createControls(parent, widgetFactory);
		this.delegates.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityPropertiesEditionPartForm.this, ContentfwkViewsRepository.DataEntity.RelatedElements.delegates, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addDelegates() {
		...
		"delegates", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityPropertiesEditionPartForm.this, ContentfwkViewsRepository.DataEntity.RelatedElements.delegates,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				delegates.refresh();
			}
	...
	protected void moveDelegates(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityPropertiesEditionPartForm.this, ContentfwkViewsRepository.DataEntity.RelatedElements.delegates, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		delegates.refresh();
	}
	...
	protected void removeFromDelegates(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityPropertiesEditionPartForm.this, ContentfwkViewsRepository.DataEntity.RelatedElements.delegates, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		delegates.refresh();
	}
	...
	protected Composite createIsDelegatedByReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.isDelegatedBy.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.DataEntity.RelatedElements.isDelegatedBy, ContentfwkViewsRepository.FORM_KIND));
		this.isDelegatedBy.createControls(parent, widgetFactory);
		this.isDelegatedBy.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityPropertiesEditionPartForm.this, ContentfwkViewsRepository.DataEntity.RelatedElements.isDelegatedBy, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addIsDelegatedBy() {
		...
		"is Delegated By", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityPropertiesEditionPartForm.this, ContentfwkViewsRepository.DataEntity.RelatedElements.isDelegatedBy,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveIsDelegatedBy(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityPropertiesEditionPartForm.this, ContentfwkViewsRepository.DataEntity.RelatedElements.isDelegatedBy, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		isDelegatedBy.refresh();
	}
	...
	protected void removeFromIsDelegatedBy(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityPropertiesEditionPartForm.this, ContentfwkViewsRepository.DataEntity.RelatedElements.isDelegatedBy, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		isDelegatedBy.refresh();
	}
