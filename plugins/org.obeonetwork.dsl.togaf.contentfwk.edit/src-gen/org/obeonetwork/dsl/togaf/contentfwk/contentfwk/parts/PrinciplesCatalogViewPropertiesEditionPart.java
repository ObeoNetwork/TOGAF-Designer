 ...
 * 
 */
public interface PrinciplesCatalogViewPropertiesEditionPart {
	 ...
	 * @param newValue the Principles to update
	 * 
	 */
	public void updatePrinciples();

	/**
	 * Adds the given filter to the Principles edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	...
	/**
	 * @return true if the given element is contained inside the Principles table
	 * 
	 */
