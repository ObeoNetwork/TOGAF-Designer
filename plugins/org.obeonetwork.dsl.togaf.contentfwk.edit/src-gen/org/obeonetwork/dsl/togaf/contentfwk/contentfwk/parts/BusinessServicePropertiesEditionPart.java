 ...
 * 
 */
public interface BusinessServicePropertiesEditionPart {
	...
	/**
	 * Init the supports Objective
	 * @param settings settings for the supports Objective ReferencesTable 
	 */
	public void initSupportsObjective(ReferencesTableSettings settings);

	/**
	 * Update the supports Objective
	 * @param newValue the supports Objective to update
	 * 
	 */
	public void updateSupportsObjective();

	/**
	 * Adds the given filter to the supports Objective edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the supports Objective table
	 * 
	 */
