 ...
 * 
 */
public class DataEntityDataComponentPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, DataEntityDataComponentPropertiesEditionPart {
...
protected List<ViewerFilter> physicalDataComponentFilters = new ArrayList<ViewerFilter>();
	 ...
	 * 
	 */
	public DataEntityDataComponentPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(dataEntityDataComponentStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == ContentfwkViewsRepository.DataEntityDataComponent.Properties.dataEntity) {
					return createDataEntityAdvancedTableComposition(parent);
				}
				if (key == ContentfwkViewsRepository.DataEntityDataComponent.Properties.logicalDataComponent) {
					return createLogicalDataComponentAdvancedTableComposition(parent);
				}
				if (key == ContentfwkViewsRepository.DataEntityDataComponent.Properties.physicalDataComponent) {
					return createPhysicalDataComponentAdvancedTableComposition(parent);
				}
				return parent;
			}
		};
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(ContentfwkMessages.DataEntityDataComponentPropertiesEditionPart_PropertiesGroupLabel);
	 ...
	 * 
	 */
	protected Composite createDataEntityAdvancedTableComposition(Composite parent) {
		this.dataEntity = new ReferencesTable(ContentfwkMessages.DataEntityDataComponentPropertiesEditionPart_DataEntityLabel, new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityDataComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.DataEntityDataComponent.Properties.dataEntity, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				dataEntity.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityDataComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.DataEntityDataComponent.Properties.dataEntity, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				dataEntity.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityDataComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.DataEntityDataComponent.Properties.dataEntity, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				dataEntity.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityDataComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.DataEntityDataComponent.Properties.dataEntity, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				dataEntity.refresh();
			}
		...
		this.dataEntity.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.DataEntityDataComponent.Properties.dataEntity, ContentfwkViewsRepository.SWT_KIND));
		this.dataEntity.createControls(parent);
		this.dataEntity.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityDataComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.DataEntityDataComponent.Properties.dataEntity, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	 ...
	 * 
	 */
	protected Composite createLogicalDataComponentAdvancedTableComposition(Composite parent) {
		this.logicalDataComponent = new ReferencesTable(ContentfwkMessages.DataEntityDataComponentPropertiesEditionPart_LogicalDataComponentLabel, new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityDataComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.DataEntityDataComponent.Properties.logicalDataComponent, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				logicalDataComponent.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityDataComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.DataEntityDataComponent.Properties.logicalDataComponent, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				logicalDataComponent.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityDataComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.DataEntityDataComponent.Properties.logicalDataComponent, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				logicalDataComponent.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityDataComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.DataEntityDataComponent.Properties.logicalDataComponent, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				logicalDataComponent.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.logicalDataComponent.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.DataEntityDataComponent.Properties.logicalDataComponent, ContentfwkViewsRepository.SWT_KIND));
		this.logicalDataComponent.createControls(parent);
		this.logicalDataComponent.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityDataComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.DataEntityDataComponent.Properties.logicalDataComponent, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	 ...
	 * 
	 */
	protected Composite createPhysicalDataComponentAdvancedTableComposition(Composite parent) {
		this.physicalDataComponent = new ReferencesTable(ContentfwkMessages.DataEntityDataComponentPropertiesEditionPart_PhysicalDataComponentLabel, new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityDataComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.DataEntityDataComponent.Properties.physicalDataComponent, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				physicalDataComponent.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityDataComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.DataEntityDataComponent.Properties.physicalDataComponent, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				physicalDataComponent.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityDataComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.DataEntityDataComponent.Properties.physicalDataComponent, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				physicalDataComponent.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityDataComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.DataEntityDataComponent.Properties.physicalDataComponent, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				physicalDataComponent.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.physicalDataComponent.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.DataEntityDataComponent.Properties.physicalDataComponent, ContentfwkViewsRepository.SWT_KIND));
		this.physicalDataComponent.createControls(parent);
		this.physicalDataComponent.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DataEntityDataComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.DataEntityDataComponent.Properties.physicalDataComponent, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
