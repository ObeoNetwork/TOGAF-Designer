 ...
 * 
 */
public interface ControlPropertiesEditionPart {
	...
	/**
	 * Init the ensures Correct Operation Of Processes
	 * @param settings settings for the ensures Correct Operation Of Processes ReferencesTable 
	 */
	public void initEnsuresCorrectOperationOfProcesses(ReferencesTableSettings settings);

	/**
	 * Update the ensures Correct Operation Of Processes
	 * @param newValue the ensures Correct Operation Of Processes to update
	 * 
	 */
	public void updateEnsuresCorrectOperationOfProcesses();

	/**
	 * Adds the given filter to the ensures Correct Operation Of Processes edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	...
	/**
	 * @return true if the given element is contained inside the ensures Correct Operation Of Processes table
	 * 
	 */
