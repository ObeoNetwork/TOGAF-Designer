 ...
 * 
 */
public class OrganizationUnitPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, OrganizationUnitPropertiesEditionPart {
	 ...
	 * 
	 */
	public OrganizationUnitPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(organizationUnitStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == ContentfwkViewsRepository.OrganizationUnit.Attributes.headcount) {
					return createHeadcountText(parent);
				}
				...
				if (key == ContentfwkViewsRepository.OrganizationUnit.RelatedElements.ownsAndGovernsServices) {
					return createOwnsAndGovernsServicesAdvancedReferencesTable(parent);
				}
				...
				if (key == ContentfwkViewsRepository.OrganizationUnit.RelatedElements.ownsFunctions) {
					return createOwnsFunctionsAdvancedReferencesTable(parent);
				}
				...
				if (key == ContentfwkViewsRepository.OrganizationUnit.RelatedElements.isMotivatedByDrivers) {
					return createIsMotivatedByDriversAdvancedReferencesTable(parent);
				}
	...
	protected Composite createAttributesGroup(Composite parent) {
		...
		attributesGroup.setText(ContentfwkMessages.OrganizationUnitPropertiesEditionPart_AttributesGroupLabel);
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, ContentfwkMessages.OrganizationUnitPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.OrganizationUnit.Attributes.name, ContentfwkViewsRepository.SWT_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationUnitPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationUnit.Attributes.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.OrganizationUnit.Attributes.name, ContentfwkViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createIDText(Composite parent) {
		SWTUtils.createPartLabel(parent, ContentfwkMessages.OrganizationUnitPropertiesEditionPart_IDLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.OrganizationUnit.Attributes.iD, ContentfwkViewsRepository.SWT_KIND));
		...
		iD.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationUnitPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationUnit.Attributes.iD, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, iD.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.OrganizationUnit.Attributes.iD, ContentfwkViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createDescriptionText(Composite parent) {
		SWTUtils.createPartLabel(parent, ContentfwkMessages.OrganizationUnitPropertiesEditionPart_DescriptionLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.OrganizationUnit.Attributes.description, ContentfwkViewsRepository.SWT_KIND));
		...
		description.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationUnitPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationUnit.Attributes.description, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, description.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.OrganizationUnit.Attributes.description, ContentfwkViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createCategoryText(Composite parent) {
		SWTUtils.createPartLabel(parent, ContentfwkMessages.OrganizationUnitPropertiesEditionPart_CategoryLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.OrganizationUnit.Attributes.category, ContentfwkViewsRepository.SWT_KIND));
		...
		category.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationUnitPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationUnit.Attributes.category, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, category.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.OrganizationUnit.Attributes.category, ContentfwkViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createSourceText(Composite parent) {
		SWTUtils.createPartLabel(parent, ContentfwkMessages.OrganizationUnitPropertiesEditionPart_SourceLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.OrganizationUnit.Attributes.source, ContentfwkViewsRepository.SWT_KIND));
		...
		source.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationUnitPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationUnit.Attributes.source, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, source.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.OrganizationUnit.Attributes.source, ContentfwkViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createOwnerText(Composite parent) {
		SWTUtils.createPartLabel(parent, ContentfwkMessages.OrganizationUnitPropertiesEditionPart_OwnerLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.OrganizationUnit.Attributes.owner, ContentfwkViewsRepository.SWT_KIND));
		...
		owner.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationUnitPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationUnit.Attributes.owner, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, owner.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.OrganizationUnit.Attributes.owner, ContentfwkViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createHeadcountText(Composite parent) {
		SWTUtils.createPartLabel(parent, ContentfwkMessages.OrganizationUnitPropertiesEditionPart_HeadcountLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.OrganizationUnit.Attributes.headcount, ContentfwkViewsRepository.SWT_KIND));
		headcount = new Text(parent, SWT.BORDER);
		...
		headcount.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationUnitPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationUnit.Attributes.headcount, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, headcount.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.OrganizationUnit.Attributes.headcount, ContentfwkViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createRelatedElementsGroup(Composite parent) {
		...
		relatedElementsGroup.setText(ContentfwkMessages.OrganizationUnitPropertiesEditionPart_RelatedElementsGroupLabel);
	...
	protected Composite createOperatesInLocationFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, ContentfwkMessages.OrganizationUnitPropertiesEditionPart_OperatesInLocationLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.OrganizationUnit.RelatedElements.operatesInLocation, ContentfwkViewsRepository.SWT_KIND));
		operatesInLocation = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(ContentfwkViewsRepository.OrganizationUnit.RelatedElements.operatesInLocation, ContentfwkViewsRepository.SWT_KIND));
		...
		operatesInLocation.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationUnitPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationUnit.RelatedElements.operatesInLocation, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getOperatesInLocation()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.OrganizationUnit.RelatedElements.operatesInLocation, ContentfwkViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * 
	 */
	protected Composite createOwnsAndGovernsServicesAdvancedReferencesTable(Composite parent) {
		...
		this.ownsAndGovernsServices.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.OrganizationUnit.RelatedElements.ownsAndGovernsServices, ContentfwkViewsRepository.SWT_KIND));
		this.ownsAndGovernsServices.createControls(parent);
		this.ownsAndGovernsServices.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationUnitPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationUnit.RelatedElements.ownsAndGovernsServices, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"owns And Governs Services", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationUnitPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationUnit.RelatedElements.ownsAndGovernsServices,
	...
	protected void moveOwnsAndGovernsServices(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationUnitPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationUnit.RelatedElements.ownsAndGovernsServices, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		ownsAndGovernsServices.refresh();
	}
	...
	protected void removeFromOwnsAndGovernsServices(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationUnitPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationUnit.RelatedElements.ownsAndGovernsServices, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		ownsAndGovernsServices.refresh();
	}
	...
	protected Composite createContainsActorsAdvancedReferencesTable(Composite parent) {
		...
		this.containsActors.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.OrganizationUnit.RelatedElements.containsActors, ContentfwkViewsRepository.SWT_KIND));
		this.containsActors.createControls(parent);
		this.containsActors.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationUnitPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationUnit.RelatedElements.containsActors, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addContainsActors() {
		...
		"contains Actors", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationUnitPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationUnit.RelatedElements.containsActors,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveContainsActors(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationUnitPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationUnit.RelatedElements.containsActors, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		containsActors.refresh();
	}
	...
	protected void removeFromContainsActors(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationUnitPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationUnit.RelatedElements.containsActors, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		containsActors.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createOwnsFunctionsAdvancedReferencesTable(Composite parent) {
		...
		this.ownsFunctions.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.OrganizationUnit.RelatedElements.ownsFunctions, ContentfwkViewsRepository.SWT_KIND));
		this.ownsFunctions.createControls(parent);
		this.ownsFunctions.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationUnitPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationUnit.RelatedElements.ownsFunctions, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addOwnsFunctions() {
		...
		"owns Functions", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationUnitPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationUnit.RelatedElements.ownsFunctions,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveOwnsFunctions(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationUnitPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationUnit.RelatedElements.ownsFunctions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		ownsFunctions.refresh();
	}
	...
	protected void removeFromOwnsFunctions(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationUnitPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationUnit.RelatedElements.ownsFunctions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		ownsFunctions.refresh();
	}
	...
	protected Composite createParticipatesInProcessesAdvancedReferencesTable(Composite parent) {
		...
		this.participatesInProcesses.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.OrganizationUnit.RelatedElements.participatesInProcesses, ContentfwkViewsRepository.SWT_KIND));
		this.participatesInProcesses.createControls(parent);
		this.participatesInProcesses.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationUnitPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationUnit.RelatedElements.participatesInProcesses, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addParticipatesInProcesses() {
		...
		"participates In Processes", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationUnitPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationUnit.RelatedElements.participatesInProcesses,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveParticipatesInProcesses(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationUnitPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationUnit.RelatedElements.participatesInProcesses, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		participatesInProcesses.refresh();
	}
	...
	protected void removeFromParticipatesInProcesses(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationUnitPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationUnit.RelatedElements.participatesInProcesses, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		participatesInProcesses.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createIsMotivatedByDriversAdvancedReferencesTable(Composite parent) {
		...
		this.isMotivatedByDrivers.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.OrganizationUnit.RelatedElements.isMotivatedByDrivers, ContentfwkViewsRepository.SWT_KIND));
		this.isMotivatedByDrivers.createControls(parent);
		this.isMotivatedByDrivers.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationUnitPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationUnit.RelatedElements.isMotivatedByDrivers, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addIsMotivatedByDrivers() {
		...
		"is Motivated By Drivers", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationUnitPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationUnit.RelatedElements.isMotivatedByDrivers,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveIsMotivatedByDrivers(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationUnitPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationUnit.RelatedElements.isMotivatedByDrivers, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		isMotivatedByDrivers.refresh();
	}
	...
	protected void removeFromIsMotivatedByDrivers(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationUnitPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationUnit.RelatedElements.isMotivatedByDrivers, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		isMotivatedByDrivers.refresh();
	}
	...
	protected Composite createProducesProductsAdvancedReferencesTable(Composite parent) {
		...
		this.producesProducts.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.OrganizationUnit.RelatedElements.producesProducts, ContentfwkViewsRepository.SWT_KIND));
		this.producesProducts.createControls(parent);
		this.producesProducts.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationUnitPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationUnit.RelatedElements.producesProducts, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addProducesProducts() {
		...
		"produces Products", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationUnitPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationUnit.RelatedElements.producesProducts,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveProducesProducts(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationUnitPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationUnit.RelatedElements.producesProducts, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		producesProducts.refresh();
	}
	...
	protected void removeFromProducesProducts(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationUnitPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationUnit.RelatedElements.producesProducts, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		producesProducts.refresh();
	}
	...
	protected Composite createDelegatesAdvancedReferencesTable(Composite parent) {
		...
		this.delegates.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.OrganizationUnit.RelatedElements.delegates, ContentfwkViewsRepository.SWT_KIND));
		this.delegates.createControls(parent);
		this.delegates.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationUnitPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationUnit.RelatedElements.delegates, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addDelegates() {
		...
		"delegates", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationUnitPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationUnit.RelatedElements.delegates,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				delegates.refresh();
			}
	...
	protected void moveDelegates(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationUnitPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationUnit.RelatedElements.delegates, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		delegates.refresh();
	}
	...
	protected void removeFromDelegates(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationUnitPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationUnit.RelatedElements.delegates, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		delegates.refresh();
	}
	...
	protected Composite createIsDelegatedByAdvancedReferencesTable(Composite parent) {
		...
		this.isDelegatedBy.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.OrganizationUnit.RelatedElements.isDelegatedBy, ContentfwkViewsRepository.SWT_KIND));
		this.isDelegatedBy.createControls(parent);
		this.isDelegatedBy.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationUnitPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationUnit.RelatedElements.isDelegatedBy, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addIsDelegatedBy() {
		...
		"is Delegated By", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationUnitPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationUnit.RelatedElements.isDelegatedBy,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveIsDelegatedBy(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationUnitPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationUnit.RelatedElements.isDelegatedBy, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		isDelegatedBy.refresh();
	}
	...
	protected void removeFromIsDelegatedBy(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationUnitPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationUnit.RelatedElements.isDelegatedBy, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		isDelegatedBy.refresh();
	}
