...
public interface RequirementPropertiesEditionPart {
	...
	/**
	 * @return the statement Of Requirement
	 * 
	 */
	public String getStatementOfRequirement();

	/**
	 * Defines a new statement Of Requirement
	 * @param newValue the new statement Of Requirement to set
	 * 
	 */
	...
	/**
	 * Defines a new acceptance Criteria
	 * @param newValue the new acceptance Criteria to set
	 * 
	 */
