 ...
 * 
 */
public interface DriverGoalObjectivePropertiesEditionPart {
	...
	/**
	 * Update the drivers
	 * @param newValue the drivers to update
	 * 
	 */
	public void updateDrivers();

	/**
	 * Adds the given filter to the drivers edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	...
	/**
	 * @return true if the given element is contained inside the drivers table
	 * 
	 */
