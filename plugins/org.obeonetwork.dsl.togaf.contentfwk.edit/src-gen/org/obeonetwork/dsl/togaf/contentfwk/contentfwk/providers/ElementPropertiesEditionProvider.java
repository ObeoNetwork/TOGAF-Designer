...
import org.obeonetwork.dsl.togaf.contentfwk.contentfwk.components.ElementPropertiesEditionComponent;
...
public class ElementPropertiesEditionProvider extends PropertiesEditingProviderImpl {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof Element) 
					&& (ContentfwkPackage.eINSTANCE.getElement() == editingContext.getEObject().eClass());
	}
