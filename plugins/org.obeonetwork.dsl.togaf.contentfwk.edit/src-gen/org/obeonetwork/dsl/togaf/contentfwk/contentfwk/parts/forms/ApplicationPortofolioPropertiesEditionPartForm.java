 ...
 * 
 */
public class ApplicationPortofolioPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, ApplicationPortofolioPropertiesEditionPart {
	 ...
	 * 
	 */
	public ApplicationPortofolioPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(applicationPortofolioStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == ContentfwkViewsRepository.ApplicationPortofolio.Properties.logicalApplicationComponent) {
					return createLogicalApplicationComponentTableComposition(widgetFactory, parent);
				}
				if (key == ContentfwkViewsRepository.ApplicationPortofolio.Properties.physicalApplicationComponent) {
					return createPhysicalApplicationComponentTableComposition(widgetFactory, parent);
				}
				return parent;
			}
		};
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(ContentfwkMessages.ApplicationPortofolioPropertiesEditionPart_PropertiesGroupLabel);
	 ...
	 * 
	 */
	protected Composite createLogicalApplicationComponentTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.logicalApplicationComponent = new ReferencesTable(ContentfwkMessages.ApplicationPortofolioPropertiesEditionPart_LogicalApplicationComponentLabel, new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ApplicationPortofolioPropertiesEditionPartForm.this, ContentfwkViewsRepository.ApplicationPortofolio.Properties.logicalApplicationComponent, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				logicalApplicationComponent.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ApplicationPortofolioPropertiesEditionPartForm.this, ContentfwkViewsRepository.ApplicationPortofolio.Properties.logicalApplicationComponent, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				logicalApplicationComponent.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ApplicationPortofolioPropertiesEditionPartForm.this, ContentfwkViewsRepository.ApplicationPortofolio.Properties.logicalApplicationComponent, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				logicalApplicationComponent.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ApplicationPortofolioPropertiesEditionPartForm.this, ContentfwkViewsRepository.ApplicationPortofolio.Properties.logicalApplicationComponent, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				logicalApplicationComponent.refresh();
			}
		...
		this.logicalApplicationComponent.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.ApplicationPortofolio.Properties.logicalApplicationComponent, ContentfwkViewsRepository.FORM_KIND));
		this.logicalApplicationComponent.createControls(parent, widgetFactory);
		this.logicalApplicationComponent.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ApplicationPortofolioPropertiesEditionPartForm.this, ContentfwkViewsRepository.ApplicationPortofolio.Properties.logicalApplicationComponent, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	 ...
	 * 
	 */
	protected Composite createPhysicalApplicationComponentTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.physicalApplicationComponent = new ReferencesTable(ContentfwkMessages.ApplicationPortofolioPropertiesEditionPart_PhysicalApplicationComponentLabel, new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ApplicationPortofolioPropertiesEditionPartForm.this, ContentfwkViewsRepository.ApplicationPortofolio.Properties.physicalApplicationComponent, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				physicalApplicationComponent.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ApplicationPortofolioPropertiesEditionPartForm.this, ContentfwkViewsRepository.ApplicationPortofolio.Properties.physicalApplicationComponent, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				physicalApplicationComponent.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ApplicationPortofolioPropertiesEditionPartForm.this, ContentfwkViewsRepository.ApplicationPortofolio.Properties.physicalApplicationComponent, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				physicalApplicationComponent.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ApplicationPortofolioPropertiesEditionPartForm.this, ContentfwkViewsRepository.ApplicationPortofolio.Properties.physicalApplicationComponent, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				physicalApplicationComponent.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.physicalApplicationComponent.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.ApplicationPortofolio.Properties.physicalApplicationComponent, ContentfwkViewsRepository.FORM_KIND));
		this.physicalApplicationComponent.createControls(parent, widgetFactory);
		this.physicalApplicationComponent.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ApplicationPortofolioPropertiesEditionPartForm.this, ContentfwkViewsRepository.ApplicationPortofolio.Properties.physicalApplicationComponent, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
