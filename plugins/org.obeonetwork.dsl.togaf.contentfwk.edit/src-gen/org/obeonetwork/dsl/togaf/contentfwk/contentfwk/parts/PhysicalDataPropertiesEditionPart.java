 ...
 * 
 */
public interface PhysicalDataPropertiesEditionPart {



	/**
	 * Init the Physical Data
	 ...
	 * @param newValue the Physical Data to update
	 * 
	 */
	public void updatePhysicalData();

	/**
	 * Adds the given filter to the Physical Data edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	...
	/**
	 * @return true if the given element is contained inside the Physical Data table
	 * 
	 */
