...
public interface ProductPropertiesEditionPart {
	...
	/**
	 * Init the is Produced By Organization Units
	 * @param settings settings for the is Produced By Organization Units ReferencesTable 
	 */
	public void initIsProducedByOrganizationUnits(ReferencesTableSettings settings);

	/**
	 * Update the is Produced By Organization Units
	 * @param newValue the is Produced By Organization Units to update
	 * 
	 */
	public void updateIsProducedByOrganizationUnits();

	/**
	 * Adds the given filter to the is Produced By Organization Units edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	...
	/**
	 * @return true if the given element is contained inside the is Produced By Organization Units table
	 * 
	 */
	...
	/**
	 * Init the is Produced By Processes
	 * @param settings settings for the is Produced By Processes ReferencesTable 
	 */
	public void initIsProducedByProcesses(ReferencesTableSettings settings);

	/**
	 * Update the is Produced By Processes
	 * @param newValue the is Produced By Processes to update
	 * 
	 */
	public void updateIsProducedByProcesses();

	/**
	 * Adds the given filter to the is Produced By Processes edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the is Produced By Processes table
	 * 
	 */
