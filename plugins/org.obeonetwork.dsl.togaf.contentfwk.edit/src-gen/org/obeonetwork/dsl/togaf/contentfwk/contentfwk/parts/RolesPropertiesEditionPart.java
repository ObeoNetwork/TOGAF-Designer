 ...
 * 
 */
public interface RolesPropertiesEditionPart {
	...
	/**
	 * Update the roles
	 * @param newValue the roles to update
	 * 
	 */
	public void updateRoles();

	/**
	 * Adds the given filter to the roles edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	...
	/**
	 * @return true if the given element is contained inside the roles table
	 * 
	 */
