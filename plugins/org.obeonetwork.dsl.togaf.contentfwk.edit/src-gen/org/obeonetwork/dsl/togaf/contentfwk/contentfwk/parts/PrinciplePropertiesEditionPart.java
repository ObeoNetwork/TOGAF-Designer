 ...
 * 
 */
public interface PrinciplePropertiesEditionPart {
	...
	/**
	 * @return the principle Category
	 * 
	 */
	public Enumerator getPrincipleCategory();

	/**
	 * Init the principle Category
	...
	/**
	 * Defines a new principle Category
	 * @param newValue the new principle Category to set
	 * 
	 */
	...
	/**
	 * @return the statement Of Principle
	 * 
	 */
	public String getStatementOfPrinciple();

	/**
	 * Defines a new statement Of Principle
	 * @param newValue the new statement Of Principle to set
	 * 
	 */
	...
	/**
	 * Defines a new implication
	 * @param newValue the new implication to set
	 * 
	 */
	 ...
	 * @param newValue the new metric to set
	 * 
	 */
