...
public class LogicalDataComponentPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == ContentfwkViewsRepository.LogicalDataComponent.RelatedElements.delegates) {
			return ContentfwkPackage.eINSTANCE.getElement_Delegates();
		}
		if (editorKey == ContentfwkViewsRepository.LogicalDataComponent.RelatedElements.isDelegatedBy) {
			return ContentfwkPackage.eINSTANCE.getElement_IsDelegatedBy();
		}
		if (editorKey == ContentfwkViewsRepository.LogicalDataComponent.Attributes.name) {
			return ContentfwkPackage.eINSTANCE.getElement_Name();
		}
		if (editorKey == ContentfwkViewsRepository.LogicalDataComponent.Attributes.description) {
			return ContentfwkPackage.eINSTANCE.getElement_Description();
		}
		if (editorKey == ContentfwkViewsRepository.LogicalDataComponent.Attributes.category) {
			return ContentfwkPackage.eINSTANCE.getElement_Category();
		}
		if (editorKey == ContentfwkViewsRepository.LogicalDataComponent.Attributes.source) {
			return ContentfwkPackage.eINSTANCE.getElement_SourceDescr();
		}
		if (editorKey == ContentfwkViewsRepository.LogicalDataComponent.Attributes.owner) {
			return ContentfwkPackage.eINSTANCE.getElement_OwnerDescr();
		}
		if (editorKey == ContentfwkViewsRepository.LogicalDataComponent.Attributes.iD) {
			return ContentfwkPackage.eINSTANCE.getElement_ID();
		}
		if (editorKey == ContentfwkViewsRepository.LogicalDataComponent.Attributes.standardClass) {
			return ContentfwkPackage.eINSTANCE.getStandard_StandardClass();
		}
		if (editorKey == ContentfwkViewsRepository.LogicalDataComponent.Attributes.standardCreationDate) {
			return ContentfwkPackage.eINSTANCE.getStandard_StandardCreationDate();
		}
		if (editorKey == ContentfwkViewsRepository.LogicalDataComponent.Attributes.lastStandardCreationDate) {
			return ContentfwkPackage.eINSTANCE.getStandard_LastStandardCreationDate();
		}
		if (editorKey == ContentfwkViewsRepository.LogicalDataComponent.Attributes.nextStandardCreationDate) {
			return ContentfwkPackage.eINSTANCE.getStandard_NextStandardCreationDate();
		}
		if (editorKey == ContentfwkViewsRepository.LogicalDataComponent.Attributes.retireDate) {
			return ContentfwkPackage.eINSTANCE.getStandard_RetireDate();
		}
		if (editorKey == ContentfwkViewsRepository.LogicalDataComponent.RelatedElements.encapsulatesDataEntities) {
			return ContentfwkPackage.eINSTANCE.getLogicalDataComponent_EncapsulatesDataEntities();
		}
		if (editorKey == ContentfwkViewsRepository.LogicalDataComponent.RelatedElements.isExtendedByPhysicalDataComponents) {
			return ContentfwkPackage.eINSTANCE.getLogicalDataComponent_IsExtendedByPhysicalDataComponents();
		}
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (ContentfwkViewsRepository.LogicalDataComponent.RelatedElements.encapsulatesDataEntities == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
				...
				encapsulatesDataEntitiesSettings.move(event.getNewIndex(), (DataEntity) event.getNewValue());
			}
		}
		if (ContentfwkViewsRepository.LogicalDataComponent.RelatedElements.isExtendedByPhysicalDataComponents == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
				...
				isExtendedByPhysicalDataComponentsSettings.move(event.getNewIndex(), (PhysicalDataComponent) event.getNewValue());
			}
		}
	}
