 ...
 * 
 */
public class ContractMeasureServicesQualityPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ContractMeasureServicesQualityPropertiesEditionPart {
...
protected List<ViewerFilter> servicesQualityFilters = new ArrayList<ViewerFilter>();
	 ...
	 * 
	 */
	public ContractMeasureServicesQualityPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	 ...
	 * 
	 */
	protected Composite createContractsmeasuresGroup(Composite parent) {
		Group contractsmeasuresGroup = new Group(parent, SWT.NONE);
		contractsmeasuresGroup.setText(ContentfwkMessages.ContractMeasureServicesQualityPropertiesEditionPart_ContractsmeasuresGroupLabel);
		GridData contractsmeasuresGroupData = new GridData(GridData.FILL_HORIZONTAL);
		contractsmeasuresGroupData.horizontalSpan = 3;
		contractsmeasuresGroup.setLayoutData(contractsmeasuresGroupData);
	 ...
	 * 
	 */
	protected Composite createContractsAdvancedTableComposition(Composite parent) {
		this.contracts = new ReferencesTable(ContentfwkMessages.ContractMeasureServicesQualityPropertiesEditionPart_ContractsLabel, new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ContractMeasureServicesQualityPropertiesEditionPartImpl.this, ContentfwkViewsRepository.ContractMeasureServicesQuality.Contractsmeasures.contracts, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				contracts.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ContractMeasureServicesQualityPropertiesEditionPartImpl.this, ContentfwkViewsRepository.ContractMeasureServicesQuality.Contractsmeasures.contracts, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				contracts.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ContractMeasureServicesQualityPropertiesEditionPartImpl.this, ContentfwkViewsRepository.ContractMeasureServicesQuality.Contractsmeasures.contracts, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				contracts.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ContractMeasureServicesQualityPropertiesEditionPartImpl.this, ContentfwkViewsRepository.ContractMeasureServicesQuality.Contractsmeasures.contracts, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				contracts.refresh();
			}
		...
		this.contracts.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.ContractMeasureServicesQuality.Contractsmeasures.contracts, ContentfwkViewsRepository.SWT_KIND));
		this.contracts.createControls(parent);
		this.contracts.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ContractMeasureServicesQualityPropertiesEditionPartImpl.this, ContentfwkViewsRepository.ContractMeasureServicesQuality.Contractsmeasures.contracts, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	 ...
	 * 
	 */
	protected Composite createMeasuresAdvancedTableComposition(Composite parent) {
		this.measures = new ReferencesTable(ContentfwkMessages.ContractMeasureServicesQualityPropertiesEditionPart_MeasuresLabel, new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ContractMeasureServicesQualityPropertiesEditionPartImpl.this, ContentfwkViewsRepository.ContractMeasureServicesQuality.Contractsmeasures.measures, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				measures.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ContractMeasureServicesQualityPropertiesEditionPartImpl.this, ContentfwkViewsRepository.ContractMeasureServicesQuality.Contractsmeasures.measures, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				measures.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ContractMeasureServicesQualityPropertiesEditionPartImpl.this, ContentfwkViewsRepository.ContractMeasureServicesQuality.Contractsmeasures.measures, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				measures.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ContractMeasureServicesQualityPropertiesEditionPartImpl.this, ContentfwkViewsRepository.ContractMeasureServicesQuality.Contractsmeasures.measures, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				measures.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.measures.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.ContractMeasureServicesQuality.Contractsmeasures.measures, ContentfwkViewsRepository.SWT_KIND));
		this.measures.createControls(parent);
		this.measures.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ContractMeasureServicesQualityPropertiesEditionPartImpl.this, ContentfwkViewsRepository.ContractMeasureServicesQuality.Contractsmeasures.measures, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	 ...
	 * 
	 */
	protected Composite createServicesQualityAdvancedTableComposition(Composite parent) {
		this.servicesQuality = new ReferencesTable(ContentfwkMessages.ContractMeasureServicesQualityPropertiesEditionPart_ServicesQualityLabel, new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ContractMeasureServicesQualityPropertiesEditionPartImpl.this, ContentfwkViewsRepository.ContractMeasureServicesQuality.Contractsmeasures.servicesQuality, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				servicesQuality.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ContractMeasureServicesQualityPropertiesEditionPartImpl.this, ContentfwkViewsRepository.ContractMeasureServicesQuality.Contractsmeasures.servicesQuality, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				servicesQuality.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ContractMeasureServicesQualityPropertiesEditionPartImpl.this, ContentfwkViewsRepository.ContractMeasureServicesQuality.Contractsmeasures.servicesQuality, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				servicesQuality.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ContractMeasureServicesQualityPropertiesEditionPartImpl.this, ContentfwkViewsRepository.ContractMeasureServicesQuality.Contractsmeasures.servicesQuality, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				servicesQuality.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.servicesQuality.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.ContractMeasureServicesQuality.Contractsmeasures.servicesQuality, ContentfwkViewsRepository.SWT_KIND));
		this.servicesQuality.createControls(parent);
		this.servicesQuality.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ContractMeasureServicesQualityPropertiesEditionPartImpl.this, ContentfwkViewsRepository.ContractMeasureServicesQuality.Contractsmeasures.servicesQuality, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
