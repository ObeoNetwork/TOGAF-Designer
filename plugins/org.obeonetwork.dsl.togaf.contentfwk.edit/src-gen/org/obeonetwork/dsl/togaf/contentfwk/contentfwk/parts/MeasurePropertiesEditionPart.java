 ...
 * 
 */
public interface MeasurePropertiesEditionPart {
	...
	/**
	 * @return the decomposes Measure
	 * 
	 */
	public EObject getDecomposesMeasure();

	/**
	 * Init the decomposes Measure
	 * @param settings the combo setting
	 */
	public void initDecomposesMeasure(EObjectFlatComboSettings settings);

	/**
	 * Defines a new decomposes Measure
	 * @param newValue the new decomposes Measure to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the decomposes Measure edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	...
	/**
	 * Init the sets Performance Criteria For Objectives
	 * @param settings settings for the sets Performance Criteria For Objectives ReferencesTable 
	 */
	public void initSetsPerformanceCriteriaForObjectives(ReferencesTableSettings settings);

	/**
	 * Update the sets Performance Criteria For Objectives
	 * @param newValue the sets Performance Criteria For Objectives to update
	 * 
	 */
	public void updateSetsPerformanceCriteriaForObjectives();

	/**
	 * Adds the given filter to the sets Performance Criteria For Objectives edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the sets Performance Criteria For Objectives table
	 * 
	 */
	...
	/**
	 * Init the sets Performance Criteria For Services
	 * @param settings settings for the sets Performance Criteria For Services ReferencesTable 
	 */
	public void initSetsPerformanceCriteriaForServices(ReferencesTableSettings settings);

	/**
	 * Update the sets Performance Criteria For Services
	 * @param newValue the sets Performance Criteria For Services to update
	 * 
	 */
	public void updateSetsPerformanceCriteriaForServices();

	/**
	 * Adds the given filter to the sets Performance Criteria For Services edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the sets Performance Criteria For Services table
	 * 
	 */
