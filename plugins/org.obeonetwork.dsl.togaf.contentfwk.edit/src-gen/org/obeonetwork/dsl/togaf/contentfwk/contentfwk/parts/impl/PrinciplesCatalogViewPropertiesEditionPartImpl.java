 ...
 * 
 */
public class PrinciplesCatalogViewPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, PrinciplesCatalogViewPropertiesEditionPart {
...
protected List<ViewerFilter> principlesFilters = new ArrayList<ViewerFilter>();
	 ...
	 * 
	 */
	public PrinciplesCatalogViewPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(principlesCatalogViewStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				if (key == ContentfwkViewsRepository.PrinciplesCatalogView.Principles.class) {
					return createPrinciplesGroup(parent);
				}
				if (key == ContentfwkViewsRepository.PrinciplesCatalogView.Principles.principles_) {
					return createPrinciplesAdvancedTableComposition(parent);
				}
				return parent;
			}
		};
	 ...
	 * 
	 */
	protected Composite createPrinciplesGroup(Composite parent) {
		Group principlesGroup = new Group(parent, SWT.NONE);
		principlesGroup.setText(ContentfwkMessages.PrinciplesCatalogViewPropertiesEditionPart_PrinciplesGroupLabel);
		GridData principlesGroupData = new GridData(GridData.FILL_HORIZONTAL);
		principlesGroupData.horizontalSpan = 3;
		principlesGroup.setLayoutData(principlesGroupData);
	 ...
	 * 
	 */
	protected Composite createPrinciplesAdvancedTableComposition(Composite parent) {
		this.principles = new ReferencesTable(ContentfwkMessages.PrinciplesCatalogViewPropertiesEditionPart_PrinciplesLabel, new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PrinciplesCatalogViewPropertiesEditionPartImpl.this, ContentfwkViewsRepository.PrinciplesCatalogView.Principles.principles_, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				principles.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PrinciplesCatalogViewPropertiesEditionPartImpl.this, ContentfwkViewsRepository.PrinciplesCatalogView.Principles.principles_, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				principles.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PrinciplesCatalogViewPropertiesEditionPartImpl.this, ContentfwkViewsRepository.PrinciplesCatalogView.Principles.principles_, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				principles.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PrinciplesCatalogViewPropertiesEditionPartImpl.this, ContentfwkViewsRepository.PrinciplesCatalogView.Principles.principles_, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				principles.refresh();
			}
		...
		this.principles.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PrinciplesCatalogView.Principles.principles_, ContentfwkViewsRepository.SWT_KIND));
		this.principles.createControls(parent);
		this.principles.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PrinciplesCatalogViewPropertiesEditionPartImpl.this, ContentfwkViewsRepository.PrinciplesCatalogView.Principles.principles_, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
