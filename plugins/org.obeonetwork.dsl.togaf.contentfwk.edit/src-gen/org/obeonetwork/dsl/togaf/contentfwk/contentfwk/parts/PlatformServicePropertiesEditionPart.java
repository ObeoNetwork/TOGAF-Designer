 ...
 * 
 */
public interface PlatformServicePropertiesEditionPart {
	...
	/**
	 * Init the is Supplied By Logical Technology Components
	 * @param settings settings for the is Supplied By Logical Technology Components ReferencesTable 
	 */
	public void initIsSuppliedByLogicalTechnologyComponents(ReferencesTableSettings settings);

	/**
	 * Update the is Supplied By Logical Technology Components
	 * @param newValue the is Supplied By Logical Technology Components to update
	 * 
	 */
	public void updateIsSuppliedByLogicalTechnologyComponents();

	/**
	 * Adds the given filter to the is Supplied By Logical Technology Components edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	...
	/**
	 * @return true if the given element is contained inside the is Supplied By Logical Technology Components table
	 * 
	 */
