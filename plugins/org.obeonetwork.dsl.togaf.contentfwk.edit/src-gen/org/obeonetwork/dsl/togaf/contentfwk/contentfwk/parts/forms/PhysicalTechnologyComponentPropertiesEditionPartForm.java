 ...
 * 
 */
public class PhysicalTechnologyComponentPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, PhysicalTechnologyComponentPropertiesEditionPart {
	 ...
	 * 
	 */
	public PhysicalTechnologyComponentPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(physicalTechnologyComponentStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == ContentfwkViewsRepository.PhysicalTechnologyComponent.RelatedElements.decomposesPhysicalTechnologyComponent) {
					return createDecomposesPhysicalTechnologyComponentFlatComboViewer(parent, widgetFactory);
				}
				if (key == ContentfwkViewsRepository.PhysicalTechnologyComponent.RelatedElements.realizesApplicationComponents) {
					return createRealizesApplicationComponentsReferencesTable(widgetFactory, parent);
				}
				if (key == ContentfwkViewsRepository.PhysicalTechnologyComponent.RelatedElements.extendsLogicalTechnologyComponents) {
					return createExtendsLogicalTechnologyComponentsReferencesTable(widgetFactory, parent);
				}
				...
				if (key == ContentfwkViewsRepository.PhysicalTechnologyComponent.RelatedElements.isDependentOnPhysicalTechnologyComponents) {
					return createIsDependentOnPhysicalTechnologyComponentsReferencesTable(widgetFactory, parent);
				}
	...
	protected Composite createAttributesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		attributesSection.setText(ContentfwkMessages.PhysicalTechnologyComponentPropertiesEditionPart_AttributesGroupLabel);
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.PhysicalTechnologyComponentPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.name, ContentfwkViewsRepository.FORM_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PhysicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.name, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createIDText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.PhysicalTechnologyComponentPropertiesEditionPart_IDLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.iD, ContentfwkViewsRepository.FORM_KIND));
		...
		iD.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PhysicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.iD, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, iD.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.iD, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.PhysicalTechnologyComponentPropertiesEditionPart_DescriptionLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.description, ContentfwkViewsRepository.FORM_KIND));
		...
		description.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PhysicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.description, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, description.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.description, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createCategoryText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.PhysicalTechnologyComponentPropertiesEditionPart_CategoryLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.category, ContentfwkViewsRepository.FORM_KIND));
		...
		category.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PhysicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.category, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, category.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.category, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createSourceText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.PhysicalTechnologyComponentPropertiesEditionPart_SourceLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.source, ContentfwkViewsRepository.FORM_KIND));
		...
		source.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PhysicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.source, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, source.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.source, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createOwnerText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.PhysicalTechnologyComponentPropertiesEditionPart_OwnerLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.owner, ContentfwkViewsRepository.FORM_KIND));
		...
		owner.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PhysicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.owner, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, owner.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.owner, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createStandardClassEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.PhysicalTechnologyComponentPropertiesEditionPart_StandardClassLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.standardClass, ContentfwkViewsRepository.FORM_KIND));
		...
		standardClass.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PhysicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.standardClass, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getStandardClass()));
			}

		});
		standardClass.setID(ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.standardClass);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.standardClass, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createStandardCreationDateText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.PhysicalTechnologyComponentPropertiesEditionPart_StandardCreationDateLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.standardCreationDate, ContentfwkViewsRepository.FORM_KIND));
		...
		standardCreationDate.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PhysicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.standardCreationDate, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, standardCreationDate.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.standardCreationDate, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createLastStandardCreationDateText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.PhysicalTechnologyComponentPropertiesEditionPart_LastStandardCreationDateLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.lastStandardCreationDate, ContentfwkViewsRepository.FORM_KIND));
		...
		lastStandardCreationDate.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PhysicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.lastStandardCreationDate, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, lastStandardCreationDate.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.lastStandardCreationDate, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createNextStandardCreationDateText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.PhysicalTechnologyComponentPropertiesEditionPart_NextStandardCreationDateLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.nextStandardCreationDate, ContentfwkViewsRepository.FORM_KIND));
		...
		nextStandardCreationDate.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PhysicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.nextStandardCreationDate, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, nextStandardCreationDate.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.nextStandardCreationDate, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createRetireDateText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.PhysicalTechnologyComponentPropertiesEditionPart_RetireDateLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.retireDate, ContentfwkViewsRepository.FORM_KIND));
		...
		retireDate.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PhysicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.retireDate, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, retireDate.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.retireDate, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createProductNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.PhysicalTechnologyComponentPropertiesEditionPart_ProductNameLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.productName, ContentfwkViewsRepository.FORM_KIND));
		productName = widgetFactory.createText(parent, ""); //$NON-NLS-1$
		productName.setData(FormToolkit.KEY_DRAW_BORDER, FormToolkit.TEXT_BORDER);
		widgetFactory.paintBordersFor(parent);
		...
		productName.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PhysicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.productName, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, productName.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.productName, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createModuleNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.PhysicalTechnologyComponentPropertiesEditionPart_ModuleNameLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.moduleName, ContentfwkViewsRepository.FORM_KIND));
		moduleName = widgetFactory.createText(parent, ""); //$NON-NLS-1$
		moduleName.setData(FormToolkit.KEY_DRAW_BORDER, FormToolkit.TEXT_BORDER);
		widgetFactory.paintBordersFor(parent);
		...
		moduleName.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PhysicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.moduleName, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, moduleName.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.moduleName, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createVendorText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.PhysicalTechnologyComponentPropertiesEditionPart_VendorLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.vendor, ContentfwkViewsRepository.FORM_KIND));
		vendor = widgetFactory.createText(parent, ""); //$NON-NLS-1$
		vendor.setData(FormToolkit.KEY_DRAW_BORDER, FormToolkit.TEXT_BORDER);
		widgetFactory.paintBordersFor(parent);
		...
		vendor.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PhysicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.vendor, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, vendor.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.vendor, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createVersionText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.PhysicalTechnologyComponentPropertiesEditionPart_VersionLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.version, ContentfwkViewsRepository.FORM_KIND));
		...
		version.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PhysicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.version, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, version.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PhysicalTechnologyComponent.Attributes.version, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createRelatedElementsGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		relatedElementsSection.setText(ContentfwkMessages.PhysicalTechnologyComponentPropertiesEditionPart_RelatedElementsGroupLabel);
	 ...
	 * 
	 */
	protected Composite createDecomposesPhysicalTechnologyComponentFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, ContentfwkMessages.PhysicalTechnologyComponentPropertiesEditionPart_DecomposesPhysicalTechnologyComponentLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.PhysicalTechnologyComponent.RelatedElements.decomposesPhysicalTechnologyComponent, ContentfwkViewsRepository.FORM_KIND));
		decomposesPhysicalTechnologyComponent = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(ContentfwkViewsRepository.PhysicalTechnologyComponent.RelatedElements.decomposesPhysicalTechnologyComponent, ContentfwkViewsRepository.FORM_KIND));
		widgetFactory.adapt(decomposesPhysicalTechnologyComponent);
		...
		decomposesPhysicalTechnologyComponent.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PhysicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.PhysicalTechnologyComponent.RelatedElements.decomposesPhysicalTechnologyComponent, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getDecomposesPhysicalTechnologyComponent()));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PhysicalTechnologyComponent.RelatedElements.decomposesPhysicalTechnologyComponent, ContentfwkViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * 
	 */
	protected Composite createRealizesApplicationComponentsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.realizesApplicationComponents.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PhysicalTechnologyComponent.RelatedElements.realizesApplicationComponents, ContentfwkViewsRepository.FORM_KIND));
		this.realizesApplicationComponents.createControls(parent, widgetFactory);
		...
		"realizes Application Components", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PhysicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.PhysicalTechnologyComponent.RelatedElements.realizesApplicationComponents,
	 ...
	 * 
	 */
	protected Composite createExtendsLogicalTechnologyComponentsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.extendsLogicalTechnologyComponents.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PhysicalTechnologyComponent.RelatedElements.extendsLogicalTechnologyComponents, ContentfwkViewsRepository.FORM_KIND));
		this.extendsLogicalTechnologyComponents.createControls(parent, widgetFactory);
	...
	protected void addExtendsLogicalTechnologyComponents() {
		...
		"extends Logical Technology Components", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PhysicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.PhysicalTechnologyComponent.RelatedElements.extendsLogicalTechnologyComponents,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected Composite createIsHostedInLocationReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.isHostedInLocation.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PhysicalTechnologyComponent.RelatedElements.isHostedInLocation, ContentfwkViewsRepository.FORM_KIND));
	...
	protected void addIsHostedInLocation() {
		...
		"is Hosted In Location", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PhysicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.PhysicalTechnologyComponent.RelatedElements.isHostedInLocation,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveIsHostedInLocation(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PhysicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.PhysicalTechnologyComponent.RelatedElements.isHostedInLocation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		isHostedInLocation.refresh();
	}
	...
	protected void removeFromIsHostedInLocation(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PhysicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.PhysicalTechnologyComponent.RelatedElements.isHostedInLocation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		isHostedInLocation.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createIsDependentOnPhysicalTechnologyComponentsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.isDependentOnPhysicalTechnologyComponents.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PhysicalTechnologyComponent.RelatedElements.isDependentOnPhysicalTechnologyComponents, ContentfwkViewsRepository.FORM_KIND));
		this.isDependentOnPhysicalTechnologyComponents.createControls(parent, widgetFactory);
	...
	protected void addIsDependentOnPhysicalTechnologyComponents() {
		...
		"is Dependent On Physical Technology Components", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PhysicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.PhysicalTechnologyComponent.RelatedElements.isDependentOnPhysicalTechnologyComponents,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected Composite createDelegatesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.delegates.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PhysicalTechnologyComponent.RelatedElements.delegates, ContentfwkViewsRepository.FORM_KIND));
	...
	protected void addDelegates() {
		...
		"delegates", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PhysicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.PhysicalTechnologyComponent.RelatedElements.delegates,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				delegates.refresh();
			}
	...
	protected void moveDelegates(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PhysicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.PhysicalTechnologyComponent.RelatedElements.delegates, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		delegates.refresh();
	}
	...
	protected void removeFromDelegates(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PhysicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.PhysicalTechnologyComponent.RelatedElements.delegates, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		delegates.refresh();
	}
	...
	protected Composite createIsDelegatedByReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.isDelegatedBy.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PhysicalTechnologyComponent.RelatedElements.isDelegatedBy, ContentfwkViewsRepository.FORM_KIND));
	...
	protected void addIsDelegatedBy() {
		...
		"is Delegated By", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PhysicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.PhysicalTechnologyComponent.RelatedElements.isDelegatedBy,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveIsDelegatedBy(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PhysicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.PhysicalTechnologyComponent.RelatedElements.isDelegatedBy, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		isDelegatedBy.refresh();
	}
	...
	protected void removeFromIsDelegatedBy(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PhysicalTechnologyComponentPropertiesEditionPartForm.this, ContentfwkViewsRepository.PhysicalTechnologyComponent.RelatedElements.isDelegatedBy, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		isDelegatedBy.refresh();
	}
