 ...
 * 
 */
public class PlatformServicePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, PlatformServicePropertiesEditionPart {
	 ...
	 * 
	 */
	public PlatformServicePropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(platformServiceStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == ContentfwkViewsRepository.PlatformService.RelatedElements.isSuppliedByLogicalTechnologyComponents) {
					return createIsSuppliedByLogicalTechnologyComponentsAdvancedReferencesTable(parent);
				}
	...
	protected Composite createAttributesGroup(Composite parent) {
		...
		attributesGroup.setText(ContentfwkMessages.PlatformServicePropertiesEditionPart_AttributesGroupLabel);
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, ContentfwkMessages.PlatformServicePropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.PlatformService.Attributes.name, ContentfwkViewsRepository.SWT_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.Attributes.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PlatformService.Attributes.name, ContentfwkViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createIDText(Composite parent) {
		SWTUtils.createPartLabel(parent, ContentfwkMessages.PlatformServicePropertiesEditionPart_IDLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.PlatformService.Attributes.iD, ContentfwkViewsRepository.SWT_KIND));
		...
		iD.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.Attributes.iD, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, iD.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PlatformService.Attributes.iD, ContentfwkViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createDescriptionText(Composite parent) {
		SWTUtils.createPartLabel(parent, ContentfwkMessages.PlatformServicePropertiesEditionPart_DescriptionLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.PlatformService.Attributes.description, ContentfwkViewsRepository.SWT_KIND));
		...
		description.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.Attributes.description, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, description.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PlatformService.Attributes.description, ContentfwkViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createCategoryText(Composite parent) {
		SWTUtils.createPartLabel(parent, ContentfwkMessages.PlatformServicePropertiesEditionPart_CategoryLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.PlatformService.Attributes.category, ContentfwkViewsRepository.SWT_KIND));
		...
		category.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.Attributes.category, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, category.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PlatformService.Attributes.category, ContentfwkViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createSourceText(Composite parent) {
		SWTUtils.createPartLabel(parent, ContentfwkMessages.PlatformServicePropertiesEditionPart_SourceLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.PlatformService.Attributes.source, ContentfwkViewsRepository.SWT_KIND));
		...
		source.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.Attributes.source, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, source.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PlatformService.Attributes.source, ContentfwkViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createOwnerText(Composite parent) {
		SWTUtils.createPartLabel(parent, ContentfwkMessages.PlatformServicePropertiesEditionPart_OwnerLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.PlatformService.Attributes.owner, ContentfwkViewsRepository.SWT_KIND));
		...
		owner.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.Attributes.owner, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, owner.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PlatformService.Attributes.owner, ContentfwkViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createStandardClassEMFComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, ContentfwkMessages.PlatformServicePropertiesEditionPart_StandardClassLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.PlatformService.Attributes.standardClass, ContentfwkViewsRepository.SWT_KIND));
		...
		standardClass.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.Attributes.standardClass, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getStandardClass()));
			}

		});
		standardClass.setID(ContentfwkViewsRepository.PlatformService.Attributes.standardClass);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PlatformService.Attributes.standardClass, ContentfwkViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createStandardCreationDateText(Composite parent) {
		SWTUtils.createPartLabel(parent, ContentfwkMessages.PlatformServicePropertiesEditionPart_StandardCreationDateLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.PlatformService.Attributes.standardCreationDate, ContentfwkViewsRepository.SWT_KIND));
		...
		standardCreationDate.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.Attributes.standardCreationDate, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, standardCreationDate.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PlatformService.Attributes.standardCreationDate, ContentfwkViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createLastStandardCreationDateText(Composite parent) {
		SWTUtils.createPartLabel(parent, ContentfwkMessages.PlatformServicePropertiesEditionPart_LastStandardCreationDateLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.PlatformService.Attributes.lastStandardCreationDate, ContentfwkViewsRepository.SWT_KIND));
		...
		lastStandardCreationDate.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.Attributes.lastStandardCreationDate, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, lastStandardCreationDate.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PlatformService.Attributes.lastStandardCreationDate, ContentfwkViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createNextStandardCreationDateText(Composite parent) {
		SWTUtils.createPartLabel(parent, ContentfwkMessages.PlatformServicePropertiesEditionPart_NextStandardCreationDateLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.PlatformService.Attributes.nextStandardCreationDate, ContentfwkViewsRepository.SWT_KIND));
		...
		nextStandardCreationDate.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.Attributes.nextStandardCreationDate, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, nextStandardCreationDate.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PlatformService.Attributes.nextStandardCreationDate, ContentfwkViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createRetireDateText(Composite parent) {
		SWTUtils.createPartLabel(parent, ContentfwkMessages.PlatformServicePropertiesEditionPart_RetireDateLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.PlatformService.Attributes.retireDate, ContentfwkViewsRepository.SWT_KIND));
		...
		retireDate.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.Attributes.retireDate, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, retireDate.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PlatformService.Attributes.retireDate, ContentfwkViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createRelatedElementsGroup(Composite parent) {
		...
		relatedElementsGroup.setText(ContentfwkMessages.PlatformServicePropertiesEditionPart_RelatedElementsGroupLabel);
	 ...
	 * 
	 */
	protected Composite createIsSuppliedByLogicalTechnologyComponentsAdvancedReferencesTable(Composite parent) {
		...
		this.isSuppliedByLogicalTechnologyComponents.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PlatformService.RelatedElements.isSuppliedByLogicalTechnologyComponents, ContentfwkViewsRepository.SWT_KIND));
		this.isSuppliedByLogicalTechnologyComponents.createControls(parent);
		this.isSuppliedByLogicalTechnologyComponents.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.isSuppliedByLogicalTechnologyComponents, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void moveIsSuppliedByLogicalTechnologyComponents(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.isSuppliedByLogicalTechnologyComponents, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		isSuppliedByLogicalTechnologyComponents.refresh();
	}
	...
	protected void removeFromIsSuppliedByLogicalTechnologyComponents(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.isSuppliedByLogicalTechnologyComponents, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		isSuppliedByLogicalTechnologyComponents.refresh();
	}
	...
	protected Composite createIsRealizedThroughLogicalApplicationComponentAdvancedReferencesTable(Composite parent) {
		...
		this.isRealizedThroughLogicalApplicationComponent.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PlatformService.RelatedElements.isRealizedThroughLogicalApplicationComponent, ContentfwkViewsRepository.SWT_KIND));
		...
		this.isRealizedThroughLogicalApplicationComponent.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.isRealizedThroughLogicalApplicationComponent, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addIsRealizedThroughLogicalApplicationComponent() {
		...
		"is Realized Through Logical Application Component", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.isRealizedThroughLogicalApplicationComponent,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveIsRealizedThroughLogicalApplicationComponent(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.isRealizedThroughLogicalApplicationComponent, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		isRealizedThroughLogicalApplicationComponent.refresh();
	}
	...
	protected void removeFromIsRealizedThroughLogicalApplicationComponent(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.isRealizedThroughLogicalApplicationComponent, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		isRealizedThroughLogicalApplicationComponent.refresh();
	}
	...
	protected Composite createIsImplementedOnLogicalTechnologyComponentsAdvancedReferencesTable(Composite parent) {
		...
		this.isImplementedOnLogicalTechnologyComponents.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PlatformService.RelatedElements.isImplementedOnLogicalTechnologyComponents, ContentfwkViewsRepository.SWT_KIND));
		...
		this.isImplementedOnLogicalTechnologyComponents.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.isImplementedOnLogicalTechnologyComponents, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addIsImplementedOnLogicalTechnologyComponents() {
		...
		"is Implemented On Logical Technology Components", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.isImplementedOnLogicalTechnologyComponents,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveIsImplementedOnLogicalTechnologyComponents(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.isImplementedOnLogicalTechnologyComponents, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		isImplementedOnLogicalTechnologyComponents.refresh();
	}
	...
	protected void removeFromIsImplementedOnLogicalTechnologyComponents(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.isImplementedOnLogicalTechnologyComponents, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		isImplementedOnLogicalTechnologyComponents.refresh();
	}
	...
	protected Composite createProvidesEntitiesAdvancedReferencesTable(Composite parent) {
		...
		this.providesEntities.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PlatformService.RelatedElements.providesEntities, ContentfwkViewsRepository.SWT_KIND));
		this.providesEntities.createControls(parent);
		this.providesEntities.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.providesEntities, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addProvidesEntities() {
		...
		"provides Entities", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.providesEntities,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveProvidesEntities(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.providesEntities, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		providesEntities.refresh();
	}
	...
	protected void removeFromProvidesEntities(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.providesEntities, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		providesEntities.refresh();
	}
	...
	protected Composite createConsumesEntitiesAdvancedReferencesTable(Composite parent) {
		...
		this.consumesEntities.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PlatformService.RelatedElements.consumesEntities, ContentfwkViewsRepository.SWT_KIND));
		this.consumesEntities.createControls(parent);
		this.consumesEntities.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.consumesEntities, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addConsumesEntities() {
		...
		"consumes Entities", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.consumesEntities,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveConsumesEntities(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.consumesEntities, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		consumesEntities.refresh();
	}
	...
	protected void removeFromConsumesEntities(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.consumesEntities, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		consumesEntities.refresh();
	}
	...
	protected Composite createConsumesServicesAdvancedReferencesTable(Composite parent) {
		...
		this.consumesServices.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PlatformService.RelatedElements.consumesServices, ContentfwkViewsRepository.SWT_KIND));
		this.consumesServices.createControls(parent);
		this.consumesServices.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.consumesServices, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addConsumesServices() {
		...
		"consumes Services", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.consumesServices,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveConsumesServices(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.consumesServices, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		consumesServices.refresh();
	}
	...
	protected void removeFromConsumesServices(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.consumesServices, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		consumesServices.refresh();
	}
	...
	protected Composite createDecomposesServicesAdvancedReferencesTable(Composite parent) {
		...
		this.decomposesServices.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PlatformService.RelatedElements.decomposesServices, ContentfwkViewsRepository.SWT_KIND));
		this.decomposesServices.createControls(parent);
		this.decomposesServices.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.decomposesServices, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addDecomposesServices() {
		...
		"decomposes Services", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.decomposesServices,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveDecomposesServices(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.decomposesServices, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		decomposesServices.refresh();
	}
	...
	protected void removeFromDecomposesServices(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.decomposesServices, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		decomposesServices.refresh();
	}
	...
	protected Composite createProvidesGovernedInterfaceToAccessFunctionsAdvancedReferencesTable(Composite parent) {
		...
		this.providesGovernedInterfaceToAccessFunctions.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PlatformService.RelatedElements.providesGovernedInterfaceToAccessFunctions, ContentfwkViewsRepository.SWT_KIND));
		...
		this.providesGovernedInterfaceToAccessFunctions.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.providesGovernedInterfaceToAccessFunctions, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void moveProvidesGovernedInterfaceToAccessFunctions(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.providesGovernedInterfaceToAccessFunctions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		providesGovernedInterfaceToAccessFunctions.refresh();
	}
	...
	protected void removeFromProvidesGovernedInterfaceToAccessFunctions(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.providesGovernedInterfaceToAccessFunctions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		providesGovernedInterfaceToAccessFunctions.refresh();
	}
	...
	protected Composite createSupportsProcessesAdvancedReferencesTable(Composite parent) {
		...
		this.supportsProcesses.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PlatformService.RelatedElements.supportsProcesses, ContentfwkViewsRepository.SWT_KIND));
		this.supportsProcesses.createControls(parent);
		this.supportsProcesses.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.supportsProcesses, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addSupportsProcesses() {
		...
		"supports Processes", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.supportsProcesses,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveSupportsProcesses(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.supportsProcesses, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		supportsProcesses.refresh();
	}
	...
	protected void removeFromSupportsProcesses(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.supportsProcesses, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		supportsProcesses.refresh();
	}
	...
	protected Composite createIsRealizedByProcessesAdvancedReferencesTable(Composite parent) {
		...
		this.isRealizedByProcesses.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PlatformService.RelatedElements.isRealizedByProcesses, ContentfwkViewsRepository.SWT_KIND));
		this.isRealizedByProcesses.createControls(parent);
		this.isRealizedByProcesses.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.isRealizedByProcesses, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addIsRealizedByProcesses() {
		...
		"is Realized By Processes", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.isRealizedByProcesses,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveIsRealizedByProcesses(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.isRealizedByProcesses, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		isRealizedByProcesses.refresh();
	}
	...
	protected void removeFromIsRealizedByProcesses(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.isRealizedByProcesses, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		isRealizedByProcesses.refresh();
	}
	...
	protected Composite createResolvesEventsAdvancedReferencesTable(Composite parent) {
		...
		this.resolvesEvents.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PlatformService.RelatedElements.resolvesEvents, ContentfwkViewsRepository.SWT_KIND));
		this.resolvesEvents.createControls(parent);
		this.resolvesEvents.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.resolvesEvents, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addResolvesEvents() {
		...
		"resolves Events", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.resolvesEvents,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveResolvesEvents(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.resolvesEvents, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		resolvesEvents.refresh();
	}
	...
	protected void removeFromResolvesEvents(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.resolvesEvents, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		resolvesEvents.refresh();
	}
	...
	protected Composite createIsProvidedToActorsAdvancedReferencesTable(Composite parent) {
		...
		this.isProvidedToActors.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PlatformService.RelatedElements.isProvidedToActors, ContentfwkViewsRepository.SWT_KIND));
		this.isProvidedToActors.createControls(parent);
		this.isProvidedToActors.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.isProvidedToActors, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addIsProvidedToActors() {
		...
		"is Provided To Actors", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.isProvidedToActors,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveIsProvidedToActors(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.isProvidedToActors, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		isProvidedToActors.refresh();
	}
	...
	protected void removeFromIsProvidedToActors(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.isProvidedToActors, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		isProvidedToActors.refresh();
	}
	...
	protected Composite createIsOwnedAndGovernedByOrganizationUnitsAdvancedReferencesTable(Composite parent) {
		...
		this.isOwnedAndGovernedByOrganizationUnits.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PlatformService.RelatedElements.isOwnedAndGovernedByOrganizationUnits, ContentfwkViewsRepository.SWT_KIND));
		...
		this.isOwnedAndGovernedByOrganizationUnits.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.isOwnedAndGovernedByOrganizationUnits, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addIsOwnedAndGovernedByOrganizationUnits() {
		...
		"is Owned And Governed By Organization Units", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.isOwnedAndGovernedByOrganizationUnits,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveIsOwnedAndGovernedByOrganizationUnits(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.isOwnedAndGovernedByOrganizationUnits, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		isOwnedAndGovernedByOrganizationUnits.refresh();
	}
	...
	protected void removeFromIsOwnedAndGovernedByOrganizationUnits(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.isOwnedAndGovernedByOrganizationUnits, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		isOwnedAndGovernedByOrganizationUnits.refresh();
	}
	...
	protected Composite createIsGovernedAndMeasuredByContractsAdvancedReferencesTable(Composite parent) {
		...
		this.isGovernedAndMeasuredByContracts.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PlatformService.RelatedElements.isGovernedAndMeasuredByContracts, ContentfwkViewsRepository.SWT_KIND));
		...
		this.isGovernedAndMeasuredByContracts.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.isGovernedAndMeasuredByContracts, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addIsGovernedAndMeasuredByContracts() {
		...
		"is Governed And Measured By Contracts", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.isGovernedAndMeasuredByContracts,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveIsGovernedAndMeasuredByContracts(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.isGovernedAndMeasuredByContracts, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		isGovernedAndMeasuredByContracts.refresh();
	}
	...
	protected void removeFromIsGovernedAndMeasuredByContracts(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.isGovernedAndMeasuredByContracts, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		isGovernedAndMeasuredByContracts.refresh();
	}
	...
	protected Composite createIsTrackedAgainstMeasuresAdvancedReferencesTable(Composite parent) {
		...
		this.isTrackedAgainstMeasures.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PlatformService.RelatedElements.isTrackedAgainstMeasures, ContentfwkViewsRepository.SWT_KIND));
		...
		this.isTrackedAgainstMeasures.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.isTrackedAgainstMeasures, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addIsTrackedAgainstMeasures() {
		...
		"is Tracked Against Measures", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.isTrackedAgainstMeasures,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveIsTrackedAgainstMeasures(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.isTrackedAgainstMeasures, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		isTrackedAgainstMeasures.refresh();
	}
	...
	protected void removeFromIsTrackedAgainstMeasures(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.isTrackedAgainstMeasures, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		isTrackedAgainstMeasures.refresh();
	}
	...
	protected Composite createMeetsQualitiesAdvancedReferencesTable(Composite parent) {
		...
		this.meetsQualities.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PlatformService.RelatedElements.meetsQualities, ContentfwkViewsRepository.SWT_KIND));
		this.meetsQualities.createControls(parent);
		this.meetsQualities.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.meetsQualities, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addMeetsQualities() {
		...
		"meets Qualities", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.meetsQualities,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveMeetsQualities(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.meetsQualities, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		meetsQualities.refresh();
	}
	...
	protected void removeFromMeetsQualities(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.meetsQualities, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		meetsQualities.refresh();
	}
	...
	protected Composite createDelegatesAdvancedReferencesTable(Composite parent) {
		...
		this.delegates.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PlatformService.RelatedElements.delegates, ContentfwkViewsRepository.SWT_KIND));
		this.delegates.createControls(parent);
		this.delegates.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.delegates, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addDelegates() {
		...
		"delegates", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.delegates,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				delegates.refresh();
			}
	...
	protected void moveDelegates(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.delegates, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		delegates.refresh();
	}
	...
	protected void removeFromDelegates(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.delegates, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		delegates.refresh();
	}
	...
	protected Composite createIsDelegatedByAdvancedReferencesTable(Composite parent) {
		...
		this.isDelegatedBy.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.PlatformService.RelatedElements.isDelegatedBy, ContentfwkViewsRepository.SWT_KIND));
		this.isDelegatedBy.createControls(parent);
		this.isDelegatedBy.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.isDelegatedBy, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addIsDelegatedBy() {
		...
		"is Delegated By", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.isDelegatedBy,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveIsDelegatedBy(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.isDelegatedBy, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		isDelegatedBy.refresh();
	}
	...
	protected void removeFromIsDelegatedBy(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PlatformServicePropertiesEditionPartImpl.this, ContentfwkViewsRepository.PlatformService.RelatedElements.isDelegatedBy, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		isDelegatedBy.refresh();
	}
