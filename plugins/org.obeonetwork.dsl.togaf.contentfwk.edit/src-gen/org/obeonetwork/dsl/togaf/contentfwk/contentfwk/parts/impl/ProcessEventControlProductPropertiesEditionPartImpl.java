 ...
 * 
 */
public class ProcessEventControlProductPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ProcessEventControlProductPropertiesEditionPart {
...
protected List<ViewerFilter> productsFilters = new ArrayList<ViewerFilter>();
	 ...
	 * 
	 */
	public ProcessEventControlProductPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(processEventControlProductStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				if (key == ContentfwkViewsRepository.ProcessEventControlProduct.Processeventcontrolproduct.class) {
					return createProcesseventcontrolproductGroup(parent);
				}
				if (key == ContentfwkViewsRepository.ProcessEventControlProduct.Processeventcontrolproduct.processes) {
					return createProcessesAdvancedTableComposition(parent);
				}
				...
				if (key == ContentfwkViewsRepository.ProcessEventControlProduct.Processeventcontrolproduct.controls) {
					return createControlsAdvancedTableComposition(parent);
				}
	 ...
	 * 
	 */
	protected Composite createProcesseventcontrolproductGroup(Composite parent) {
		Group processeventcontrolproductGroup = new Group(parent, SWT.NONE);
		processeventcontrolproductGroup.setText(ContentfwkMessages.ProcessEventControlProductPropertiesEditionPart_ProcesseventcontrolproductGroupLabel);
		GridData processeventcontrolproductGroupData = new GridData(GridData.FILL_HORIZONTAL);
		processeventcontrolproductGroupData.horizontalSpan = 3;
		processeventcontrolproductGroup.setLayoutData(processeventcontrolproductGroupData);
	 ...
	 * 
	 */
	protected Composite createProcessesAdvancedTableComposition(Composite parent) {
		this.processes = new ReferencesTable(ContentfwkMessages.ProcessEventControlProductPropertiesEditionPart_ProcessesLabel, new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessEventControlProductPropertiesEditionPartImpl.this, ContentfwkViewsRepository.ProcessEventControlProduct.Processeventcontrolproduct.processes, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				processes.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessEventControlProductPropertiesEditionPartImpl.this, ContentfwkViewsRepository.ProcessEventControlProduct.Processeventcontrolproduct.processes, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				processes.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessEventControlProductPropertiesEditionPartImpl.this, ContentfwkViewsRepository.ProcessEventControlProduct.Processeventcontrolproduct.processes, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				processes.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessEventControlProductPropertiesEditionPartImpl.this, ContentfwkViewsRepository.ProcessEventControlProduct.Processeventcontrolproduct.processes, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				processes.refresh();
			}
		...
		this.processes.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.ProcessEventControlProduct.Processeventcontrolproduct.processes, ContentfwkViewsRepository.SWT_KIND));
		this.processes.createControls(parent);
		this.processes.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessEventControlProductPropertiesEditionPartImpl.this, ContentfwkViewsRepository.ProcessEventControlProduct.Processeventcontrolproduct.processes, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createEventsAdvancedTableComposition(Composite parent) {
		this.events = new ReferencesTable(ContentfwkMessages.ProcessEventControlProductPropertiesEditionPart_EventsLabel, new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessEventControlProductPropertiesEditionPartImpl.this, ContentfwkViewsRepository.ProcessEventControlProduct.Processeventcontrolproduct.events, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				events.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessEventControlProductPropertiesEditionPartImpl.this, ContentfwkViewsRepository.ProcessEventControlProduct.Processeventcontrolproduct.events, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				events.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessEventControlProductPropertiesEditionPartImpl.this, ContentfwkViewsRepository.ProcessEventControlProduct.Processeventcontrolproduct.events, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				events.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessEventControlProductPropertiesEditionPartImpl.this, ContentfwkViewsRepository.ProcessEventControlProduct.Processeventcontrolproduct.events, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				events.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.events.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.ProcessEventControlProduct.Processeventcontrolproduct.events, ContentfwkViewsRepository.SWT_KIND));
	 ...
	 * 
	 */
	protected Composite createControlsAdvancedTableComposition(Composite parent) {
		this.controls = new ReferencesTable(ContentfwkMessages.ProcessEventControlProductPropertiesEditionPart_ControlsLabel, new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessEventControlProductPropertiesEditionPartImpl.this, ContentfwkViewsRepository.ProcessEventControlProduct.Processeventcontrolproduct.controls, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				controls.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessEventControlProductPropertiesEditionPartImpl.this, ContentfwkViewsRepository.ProcessEventControlProduct.Processeventcontrolproduct.controls, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				controls.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessEventControlProductPropertiesEditionPartImpl.this, ContentfwkViewsRepository.ProcessEventControlProduct.Processeventcontrolproduct.controls, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				controls.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessEventControlProductPropertiesEditionPartImpl.this, ContentfwkViewsRepository.ProcessEventControlProduct.Processeventcontrolproduct.controls, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				controls.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.controls.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.ProcessEventControlProduct.Processeventcontrolproduct.controls, ContentfwkViewsRepository.SWT_KIND));
	...
	protected Composite createProductsAdvancedTableComposition(Composite parent) {
		this.products = new ReferencesTable(ContentfwkMessages.ProcessEventControlProductPropertiesEditionPart_ProductsLabel, new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessEventControlProductPropertiesEditionPartImpl.this, ContentfwkViewsRepository.ProcessEventControlProduct.Processeventcontrolproduct.products, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				products.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessEventControlProductPropertiesEditionPartImpl.this, ContentfwkViewsRepository.ProcessEventControlProduct.Processeventcontrolproduct.products, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				products.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessEventControlProductPropertiesEditionPartImpl.this, ContentfwkViewsRepository.ProcessEventControlProduct.Processeventcontrolproduct.products, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				products.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessEventControlProductPropertiesEditionPartImpl.this, ContentfwkViewsRepository.ProcessEventControlProduct.Processeventcontrolproduct.products, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				products.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.products.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.ProcessEventControlProduct.Processeventcontrolproduct.products, ContentfwkViewsRepository.SWT_KIND));
