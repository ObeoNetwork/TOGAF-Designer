 ...
 * 
 */
public interface PhysicalDataComponentPropertiesEditionPart {
	...
	/**
	 * @return the is Hoted In Location
	 * 
	 */
	public EObject getIsHotedInLocation();

	/**
	 * Init the is Hoted In Location
	 * @param settings the combo setting
	 */
	public void initIsHotedInLocation(EObjectFlatComboSettings settings);

	/**
	 * Defines a new is Hoted In Location
	 * @param newValue the new is Hoted In Location to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the is Hoted In Location edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	...
	/**
	 * @return the decomposes Physical Data Component
	 * 
	 */
	public EObject getDecomposesPhysicalDataComponent();

	/**
	 * Init the decomposes Physical Data Component
	 * @param settings the combo setting
	 */
	public void initDecomposesPhysicalDataComponent(EObjectFlatComboSettings settings);

	/**
	 * Defines a new decomposes Physical Data Component
	 * @param newValue the new decomposes Physical Data Component to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the decomposes Physical Data Component edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * Init the extends Logical Data Components
	 * @param settings settings for the extends Logical Data Components ReferencesTable 
	 */
	public void initExtendsLogicalDataComponents(ReferencesTableSettings settings);

	/**
	 * Update the extends Logical Data Components
	 * @param newValue the extends Logical Data Components to update
	 * 
	 */
	public void updateExtendsLogicalDataComponents();

	/**
	 * Adds the given filter to the extends Logical Data Components edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the extends Logical Data Components table
	 * 
	 */
	...
	/**
	 * Init the encapsulates Physical Application Components
	 * @param settings settings for the encapsulates Physical Application Components ReferencesTable 
	 */
	public void initEncapsulatesPhysicalApplicationComponents(ReferencesTableSettings settings);

	/**
	 * Update the encapsulates Physical Application Components
	 * @param newValue the encapsulates Physical Application Components to update
	 * 
	 */
	public void updateEncapsulatesPhysicalApplicationComponents();

	/**
	 * Adds the given filter to the encapsulates Physical Application Components edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the encapsulates Physical Application Components table
	 * 
	 */
