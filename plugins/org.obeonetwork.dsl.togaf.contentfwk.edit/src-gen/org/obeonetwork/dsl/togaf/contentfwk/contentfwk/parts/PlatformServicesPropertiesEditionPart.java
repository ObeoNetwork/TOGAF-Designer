 ...
 * 
 */
public interface PlatformServicesPropertiesEditionPart {



	/**
	 * Init the Platform Services
	...
	/**
	 * Update the Platform Services
	 * @param newValue the Platform Services to update
	 * 
	 */
	public void updatePlatformServices();

	/**
	 * Adds the given filter to the Platform Services edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	...
	/**
	 * @return true if the given element is contained inside the Platform Services table
	 * 
	 */
