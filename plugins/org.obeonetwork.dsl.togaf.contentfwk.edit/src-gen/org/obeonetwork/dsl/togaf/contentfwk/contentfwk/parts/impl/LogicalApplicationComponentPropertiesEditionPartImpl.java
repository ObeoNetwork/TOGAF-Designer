 ...
 * 
 */
public class LogicalApplicationComponentPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, LogicalApplicationComponentPropertiesEditionPart {
	 ...
	 * 
	 */
	public LogicalApplicationComponentPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(logicalApplicationComponentStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == ContentfwkViewsRepository.LogicalApplicationComponent.RelatedElements.decomposesLogicalApplicationComponent) {
					return createDecomposesLogicalApplicationComponentFlatComboViewer(parent);
				}
				if (key == ContentfwkViewsRepository.LogicalApplicationComponent.RelatedElements.isExtendedByPhysicalApplicationComponents) {
					return createIsExtendedByPhysicalApplicationComponentsAdvancedReferencesTable(parent);
				}
				...
				if (key == ContentfwkViewsRepository.LogicalApplicationComponent.RelatedElements.operatesOnDataEntities) {
					return createOperatesOnDataEntitiesAdvancedReferencesTable(parent);
				}
				if (key == ContentfwkViewsRepository.LogicalApplicationComponent.RelatedElements.implementsServices) {
					return createImplementsServicesAdvancedReferencesTable(parent);
				}
	...
	protected Composite createAttributesGroup(Composite parent) {
		...
		attributesGroup.setText(ContentfwkMessages.LogicalApplicationComponentPropertiesEditionPart_AttributesGroupLabel);
	...
	protected Composite createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, ContentfwkMessages.LogicalApplicationComponentPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.LogicalApplicationComponent.Attributes.name, ContentfwkViewsRepository.SWT_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalApplicationComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.LogicalApplicationComponent.Attributes.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.LogicalApplicationComponent.Attributes.name, ContentfwkViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createIDText(Composite parent) {
		SWTUtils.createPartLabel(parent, ContentfwkMessages.LogicalApplicationComponentPropertiesEditionPart_IDLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.LogicalApplicationComponent.Attributes.iD, ContentfwkViewsRepository.SWT_KIND));
		...
		iD.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalApplicationComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.LogicalApplicationComponent.Attributes.iD, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, iD.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.LogicalApplicationComponent.Attributes.iD, ContentfwkViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createDescriptionText(Composite parent) {
		SWTUtils.createPartLabel(parent, ContentfwkMessages.LogicalApplicationComponentPropertiesEditionPart_DescriptionLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.LogicalApplicationComponent.Attributes.description, ContentfwkViewsRepository.SWT_KIND));
		...
		description.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalApplicationComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.LogicalApplicationComponent.Attributes.description, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, description.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.LogicalApplicationComponent.Attributes.description, ContentfwkViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createCategoryText(Composite parent) {
		SWTUtils.createPartLabel(parent, ContentfwkMessages.LogicalApplicationComponentPropertiesEditionPart_CategoryLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.LogicalApplicationComponent.Attributes.category, ContentfwkViewsRepository.SWT_KIND));
		...
		category.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalApplicationComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.LogicalApplicationComponent.Attributes.category, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, category.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.LogicalApplicationComponent.Attributes.category, ContentfwkViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createSourceText(Composite parent) {
		SWTUtils.createPartLabel(parent, ContentfwkMessages.LogicalApplicationComponentPropertiesEditionPart_SourceLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.LogicalApplicationComponent.Attributes.source, ContentfwkViewsRepository.SWT_KIND));
		...
		source.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalApplicationComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.LogicalApplicationComponent.Attributes.source, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, source.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.LogicalApplicationComponent.Attributes.source, ContentfwkViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createOwnerText(Composite parent) {
		SWTUtils.createPartLabel(parent, ContentfwkMessages.LogicalApplicationComponentPropertiesEditionPart_OwnerLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.LogicalApplicationComponent.Attributes.owner, ContentfwkViewsRepository.SWT_KIND));
		...
		owner.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalApplicationComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.LogicalApplicationComponent.Attributes.owner, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, owner.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.LogicalApplicationComponent.Attributes.owner, ContentfwkViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createStandardClassEMFComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, ContentfwkMessages.LogicalApplicationComponentPropertiesEditionPart_StandardClassLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.LogicalApplicationComponent.Attributes.standardClass, ContentfwkViewsRepository.SWT_KIND));
		...
		standardClass.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalApplicationComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.LogicalApplicationComponent.Attributes.standardClass, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getStandardClass()));
			}

		});
		standardClass.setID(ContentfwkViewsRepository.LogicalApplicationComponent.Attributes.standardClass);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.LogicalApplicationComponent.Attributes.standardClass, ContentfwkViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createStandardCreationDateText(Composite parent) {
		SWTUtils.createPartLabel(parent, ContentfwkMessages.LogicalApplicationComponentPropertiesEditionPart_StandardCreationDateLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.LogicalApplicationComponent.Attributes.standardCreationDate, ContentfwkViewsRepository.SWT_KIND));
		...
		standardCreationDate.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalApplicationComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.LogicalApplicationComponent.Attributes.standardCreationDate, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, standardCreationDate.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.LogicalApplicationComponent.Attributes.standardCreationDate, ContentfwkViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createLastStandardCreationDateText(Composite parent) {
		SWTUtils.createPartLabel(parent, ContentfwkMessages.LogicalApplicationComponentPropertiesEditionPart_LastStandardCreationDateLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.LogicalApplicationComponent.Attributes.lastStandardCreationDate, ContentfwkViewsRepository.SWT_KIND));
		...
		lastStandardCreationDate.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalApplicationComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.LogicalApplicationComponent.Attributes.lastStandardCreationDate, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, lastStandardCreationDate.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.LogicalApplicationComponent.Attributes.lastStandardCreationDate, ContentfwkViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createNextStandardCreationDateText(Composite parent) {
		SWTUtils.createPartLabel(parent, ContentfwkMessages.LogicalApplicationComponentPropertiesEditionPart_NextStandardCreationDateLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.LogicalApplicationComponent.Attributes.nextStandardCreationDate, ContentfwkViewsRepository.SWT_KIND));
		...
		nextStandardCreationDate.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalApplicationComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.LogicalApplicationComponent.Attributes.nextStandardCreationDate, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, nextStandardCreationDate.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.LogicalApplicationComponent.Attributes.nextStandardCreationDate, ContentfwkViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createRetireDateText(Composite parent) {
		SWTUtils.createPartLabel(parent, ContentfwkMessages.LogicalApplicationComponentPropertiesEditionPart_RetireDateLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.LogicalApplicationComponent.Attributes.retireDate, ContentfwkViewsRepository.SWT_KIND));
		...
		retireDate.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalApplicationComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.LogicalApplicationComponent.Attributes.retireDate, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, retireDate.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.LogicalApplicationComponent.Attributes.retireDate, ContentfwkViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createRelatedElementsGroup(Composite parent) {
		...
		relatedElementsGroup.setText(ContentfwkMessages.LogicalApplicationComponentPropertiesEditionPart_RelatedElementsGroupLabel);
	 ...
	 * 
	 */
	protected Composite createDecomposesLogicalApplicationComponentFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, ContentfwkMessages.LogicalApplicationComponentPropertiesEditionPart_DecomposesLogicalApplicationComponentLabel, propertiesEditionComponent.isRequired(ContentfwkViewsRepository.LogicalApplicationComponent.RelatedElements.decomposesLogicalApplicationComponent, ContentfwkViewsRepository.SWT_KIND));
		decomposesLogicalApplicationComponent = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(ContentfwkViewsRepository.LogicalApplicationComponent.RelatedElements.decomposesLogicalApplicationComponent, ContentfwkViewsRepository.SWT_KIND));
		...
		decomposesLogicalApplicationComponent.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalApplicationComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.LogicalApplicationComponent.RelatedElements.decomposesLogicalApplicationComponent, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getDecomposesLogicalApplicationComponent()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.LogicalApplicationComponent.RelatedElements.decomposesLogicalApplicationComponent, ContentfwkViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * 
	 */
	protected Composite createIsExtendedByPhysicalApplicationComponentsAdvancedReferencesTable(Composite parent) {
		...
		this.isExtendedByPhysicalApplicationComponents.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.LogicalApplicationComponent.RelatedElements.isExtendedByPhysicalApplicationComponents, ContentfwkViewsRepository.SWT_KIND));
		this.isExtendedByPhysicalApplicationComponents.createControls(parent);
		this.isExtendedByPhysicalApplicationComponents.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalApplicationComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.LogicalApplicationComponent.RelatedElements.isExtendedByPhysicalApplicationComponents, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"is Extended By Physical Application Components", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalApplicationComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.LogicalApplicationComponent.RelatedElements.isExtendedByPhysicalApplicationComponents,
	...
	protected void moveIsExtendedByPhysicalApplicationComponents(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalApplicationComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.LogicalApplicationComponent.RelatedElements.isExtendedByPhysicalApplicationComponents, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		isExtendedByPhysicalApplicationComponents.refresh();
	}
	...
	protected void removeFromIsExtendedByPhysicalApplicationComponents(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalApplicationComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.LogicalApplicationComponent.RelatedElements.isExtendedByPhysicalApplicationComponents, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		isExtendedByPhysicalApplicationComponents.refresh();
	}
	...
	protected Composite createCommunicatesWithAdvancedReferencesTable(Composite parent) {
		...
		this.communicatesWith.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.LogicalApplicationComponent.RelatedElements.communicatesWith, ContentfwkViewsRepository.SWT_KIND));
		this.communicatesWith.createControls(parent);
		this.communicatesWith.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalApplicationComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.LogicalApplicationComponent.RelatedElements.communicatesWith, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addCommunicatesWith() {
		...
		"communicates With", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalApplicationComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.LogicalApplicationComponent.RelatedElements.communicatesWith,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveCommunicatesWith(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalApplicationComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.LogicalApplicationComponent.RelatedElements.communicatesWith, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		communicatesWith.refresh();
	}
	...
	protected void removeFromCommunicatesWith(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalApplicationComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.LogicalApplicationComponent.RelatedElements.communicatesWith, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		communicatesWith.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createOperatesOnDataEntitiesAdvancedReferencesTable(Composite parent) {
		...
		this.operatesOnDataEntities.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.LogicalApplicationComponent.RelatedElements.operatesOnDataEntities, ContentfwkViewsRepository.SWT_KIND));
		this.operatesOnDataEntities.createControls(parent);
		this.operatesOnDataEntities.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalApplicationComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.LogicalApplicationComponent.RelatedElements.operatesOnDataEntities, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addOperatesOnDataEntities() {
		...
		"operates On Data Entities", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalApplicationComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.LogicalApplicationComponent.RelatedElements.operatesOnDataEntities,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveOperatesOnDataEntities(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalApplicationComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.LogicalApplicationComponent.RelatedElements.operatesOnDataEntities, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		operatesOnDataEntities.refresh();
	}
	...
	protected void removeFromOperatesOnDataEntities(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalApplicationComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.LogicalApplicationComponent.RelatedElements.operatesOnDataEntities, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		operatesOnDataEntities.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createImplementsServicesAdvancedReferencesTable(Composite parent) {
		...
		this.implementsServices.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.LogicalApplicationComponent.RelatedElements.implementsServices, ContentfwkViewsRepository.SWT_KIND));
		this.implementsServices.createControls(parent);
		this.implementsServices.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalApplicationComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.LogicalApplicationComponent.RelatedElements.implementsServices, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addImplementsServices() {
		...
		"implements Services", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalApplicationComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.LogicalApplicationComponent.RelatedElements.implementsServices,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveImplementsServices(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalApplicationComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.LogicalApplicationComponent.RelatedElements.implementsServices, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		implementsServices.refresh();
	}
	...
	protected void removeFromImplementsServices(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalApplicationComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.LogicalApplicationComponent.RelatedElements.implementsServices, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		implementsServices.refresh();
	}
	...
	protected Composite createDelegatesAdvancedReferencesTable(Composite parent) {
		...
		this.delegates.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.LogicalApplicationComponent.RelatedElements.delegates, ContentfwkViewsRepository.SWT_KIND));
		this.delegates.createControls(parent);
		this.delegates.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalApplicationComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.LogicalApplicationComponent.RelatedElements.delegates, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addDelegates() {
		...
		"delegates", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalApplicationComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.LogicalApplicationComponent.RelatedElements.delegates,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				delegates.refresh();
			}
	...
	protected void moveDelegates(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalApplicationComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.LogicalApplicationComponent.RelatedElements.delegates, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		delegates.refresh();
	}
	...
	protected void removeFromDelegates(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalApplicationComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.LogicalApplicationComponent.RelatedElements.delegates, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		delegates.refresh();
	}
	...
	protected Composite createIsDelegatedByAdvancedReferencesTable(Composite parent) {
		...
		this.isDelegatedBy.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.LogicalApplicationComponent.RelatedElements.isDelegatedBy, ContentfwkViewsRepository.SWT_KIND));
		this.isDelegatedBy.createControls(parent);
		this.isDelegatedBy.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalApplicationComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.LogicalApplicationComponent.RelatedElements.isDelegatedBy, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addIsDelegatedBy() {
		...
		"is Delegated By", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalApplicationComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.LogicalApplicationComponent.RelatedElements.isDelegatedBy,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveIsDelegatedBy(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalApplicationComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.LogicalApplicationComponent.RelatedElements.isDelegatedBy, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		isDelegatedBy.refresh();
	}
	...
	protected void removeFromIsDelegatedBy(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogicalApplicationComponentPropertiesEditionPartImpl.this, ContentfwkViewsRepository.LogicalApplicationComponent.RelatedElements.isDelegatedBy, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		isDelegatedBy.refresh();
	}
