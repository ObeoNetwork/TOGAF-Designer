...
public interface ContainerPropertiesEditionPart {
	...
	/**
	 * Init the owns Elements
	 * @param settings settings for the owns Elements ReferencesTable 
	 */
	public void initOwnsElements(ReferencesTableSettings settings);

	/**
	 * Update the owns Elements
	 * @param newValue the owns Elements to update
	 * 
	 */
	public void updateOwnsElements();

	/**
	 * Adds the given filter to the owns Elements edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	...
	/**
	 * @return true if the given element is contained inside the owns Elements table
	 * 
	 */
