 ...
 * 
 */
public interface WorkPackagePropertiesEditionPart {
	...
	/**
	 * @return the work Package Category
	 * 
	 */
	public Enumerator getWorkPackageCategory();

	/**
	 * Init the work Package Category
	...
	/**
	 * Defines a new work Package Category
	 * @param newValue the new work Package Category to set
	 * 
	 */
	...
	/**
	 * Init the delivers Capabilities
	 * @param settings settings for the delivers Capabilities ReferencesTable 
	 */
	public void initDeliversCapabilities(ReferencesTableSettings settings);

	/**
	 * Update the delivers Capabilities
	 * @param newValue the delivers Capabilities to update
	 * 
	 */
	public void updateDeliversCapabilities();

	/**
	 * Adds the given filter to the delivers Capabilities edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	...
	/**
	 * @return true if the given element is contained inside the delivers Capabilities table
	 * 
	 */
