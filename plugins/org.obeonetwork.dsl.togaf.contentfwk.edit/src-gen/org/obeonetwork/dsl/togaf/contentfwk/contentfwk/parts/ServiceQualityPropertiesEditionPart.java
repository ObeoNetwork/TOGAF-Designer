 ...
 * 
 */
public interface ServiceQualityPropertiesEditionPart {
	...
	/**
	 * Init the applies To Services
	 * @param settings settings for the applies To Services ReferencesTable 
	 */
	public void initAppliesToServices(ReferencesTableSettings settings);

	/**
	 * Update the applies To Services
	 * @param newValue the applies To Services to update
	 * 
	 */
	public void updateAppliesToServices();

	/**
	 * Adds the given filter to the applies To Services edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	...
	/**
	 * @return true if the given element is contained inside the applies To Services table
	 * 
	 */
	...
	/**
	 * Init the applies To Contracts
	 * @param settings settings for the applies To Contracts ReferencesTable 
	 */
	public void initAppliesToContracts(ReferencesTableSettings settings);

	/**
	 * Update the applies To Contracts
	 * @param newValue the applies To Contracts to update
	 * 
	 */
	public void updateAppliesToContracts();

	/**
	 * Adds the given filter to the applies To Contracts edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the applies To Contracts table
	 * 
	 */
