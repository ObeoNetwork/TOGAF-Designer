 ...
 * 
 */
public class OrganizationActorPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, OrganizationActorPropertiesEditionPart {
...
protected List<ViewerFilter> actorsFilters = new ArrayList<ViewerFilter>();
	 ...
	 * 
	 */
	public OrganizationActorPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(organizationActorStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == ContentfwkViewsRepository.OrganizationActor.Organizationactors.organizations) {
					return createOrganizationsAdvancedTableComposition(parent);
				}
				if (key == ContentfwkViewsRepository.OrganizationActor.Organizationactors.actors) {
					return createActorsAdvancedTableComposition(parent);
				}
				return parent;
			}
		};
	...
	protected Composite createOrganizationactorsGroup(Composite parent) {
		...
		organizationactorsGroup.setText(ContentfwkMessages.OrganizationActorPropertiesEditionPart_OrganizationactorsGroupLabel);
	 ...
	 * 
	 */
	protected Composite createOrganizationsAdvancedTableComposition(Composite parent) {
		this.organizations = new ReferencesTable(ContentfwkMessages.OrganizationActorPropertiesEditionPart_OrganizationsLabel, new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationActorPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationActor.Organizationactors.organizations, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				organizations.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationActorPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationActor.Organizationactors.organizations, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				organizations.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationActorPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationActor.Organizationactors.organizations, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				organizations.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationActorPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationActor.Organizationactors.organizations, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				organizations.refresh();
			}
		...
		this.organizations.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.OrganizationActor.Organizationactors.organizations, ContentfwkViewsRepository.SWT_KIND));
		this.organizations.createControls(parent);
		this.organizations.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationActorPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationActor.Organizationactors.organizations, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	 ...
	 * 
	 */
	protected Composite createActorsAdvancedTableComposition(Composite parent) {
		this.actors = new ReferencesTable(ContentfwkMessages.OrganizationActorPropertiesEditionPart_ActorsLabel, new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationActorPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationActor.Organizationactors.actors, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				actors.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationActorPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationActor.Organizationactors.actors, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				actors.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationActorPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationActor.Organizationactors.actors, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				actors.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationActorPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationActor.Organizationactors.actors, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				actors.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.actors.setHelpText(propertiesEditionComponent.getHelpContent(ContentfwkViewsRepository.OrganizationActor.Organizationactors.actors, ContentfwkViewsRepository.SWT_KIND));
		this.actors.createControls(parent);
		this.actors.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OrganizationActorPropertiesEditionPartImpl.this, ContentfwkViewsRepository.OrganizationActor.Organizationactors.actors, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
