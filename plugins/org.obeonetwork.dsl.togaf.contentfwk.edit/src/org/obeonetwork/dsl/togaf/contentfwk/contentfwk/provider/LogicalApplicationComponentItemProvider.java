	...
	protected void addAnyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LogicalApplicationComponent_any_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LogicalApplicationComponent_any_feature", "_UI_LogicalApplicationComponent_type"),
				 ContentfwkPackage.Literals.LOGICAL_APPLICATION_COMPONENT__ANY,
				 true,
				 false,
				 true,
				 null,
