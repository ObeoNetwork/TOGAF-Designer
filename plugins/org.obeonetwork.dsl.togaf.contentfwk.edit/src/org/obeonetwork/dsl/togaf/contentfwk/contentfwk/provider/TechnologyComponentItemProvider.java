...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.togaf.contentfwk.contentfwk.TechnologyComponent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TechnologyComponentItemProvider
	 ...
	 * @generated
	 */
	public TechnologyComponentItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		StandardsClass labelValue = ((TechnologyComponent)object).getStandardClass();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_TechnologyComponent_type") :
			getString("_UI_TechnologyComponent_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TechnologyComponent.class)) {
